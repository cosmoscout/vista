...
class PyDfnNode : public IVdfnNode {
 public:
  ...
  void pyRegisterEvalCallback(boost::python::object
          evalCallback); // register a python function to be called on graph evaluation
 ...
 private:
  ...
  boost::python::object
                                               _evalCallback; // python callback function to be called on graph evaluation (DoEvalNode())
