...
bool VdfnPlaneConstraintNode::DoEvalNode() {
  ...
  VistaVector3D v3InternalForce =
      (m_pInternalForce ? m_pInternalForce->GetValue() : VistaVector3D());
  ...
  return m_pPlaneConstraint->SetConstraintPlane(
      v3Origin, v3Normal, nStiffness, nDamping, v3InternalForce);
}
