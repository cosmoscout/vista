...
BoundingboxGeometry::BoundingboxGeometry(VistaSceneGraph* pVistaSG, VistaBoundingBox& bb) {
  ...
  // creating lines
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Min[0], v3Min[1], v3Min[2]),
      VistaVector3D(v3Min[0], v3Min[1], v3Max[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Min[0], v3Min[1], v3Max[2]),
      VistaVector3D(v3Max[0], v3Min[1], v3Max[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Max[0], v3Min[1], v3Max[2]),
      VistaVector3D(v3Max[0], v3Min[1], v3Min[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Max[0], v3Min[1], v3Min[2]),
      VistaVector3D(v3Min[0], v3Min[1], v3Min[2])));

  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Min[0], v3Min[1], v3Min[2]),
      VistaVector3D(v3Min[0], v3Max[1], v3Min[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Min[0], v3Min[1], v3Max[2]),
      VistaVector3D(v3Min[0], v3Max[1], v3Max[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Max[0], v3Min[1], v3Max[2]),
      VistaVector3D(v3Max[0], v3Max[1], v3Max[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Max[0], v3Min[1], v3Min[2]),
      VistaVector3D(v3Max[0], v3Max[1], v3Min[2])));

  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Max[0], v3Max[1], v3Min[2]),
      VistaVector3D(v3Min[0], v3Max[1], v3Min[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Min[0], v3Max[1], v3Min[2]),
      VistaVector3D(v3Min[0], v3Max[1], v3Max[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Min[0], v3Max[1], v3Max[2]),
      VistaVector3D(v3Max[0], v3Max[1], v3Max[2])));
  pNode->AddChild(createLine(pVistaSG, VistaVector3D(v3Max[0], v3Max[1], v3Max[2]),
      VistaVector3D(v3Max[0], v3Max[1], v3Min[2])));
 ...
 */
VistaTransformNode* BoundingboxGeometry::createLine(
    VistaSceneGraph* pVistaSG, const VistaVector3D& a, const VistaVector3D& b) {
