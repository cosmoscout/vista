...
if (NOT VOPENSG_FOUND)
	...
	if (OPENSG_ROOT_DIR)
		...
		find_library(OPENSG_SYSTEM_LIBRARY_RELEASE
				NAMES OSGSystem OSGSystem.lib libOSGSystem.so
				PATHS ${OPENSG_LIBRARY_SEARCH_DIRS}
				NO_DEFAULT_PATH
		)

		find_library(OPENSG_BASE_LIBRARY_RELEASE
				NAMES OSGBase OSGBase.lib libOSGBase.so
				PATHS ${OPENSG_LIBRARY_SEARCH_DIRS}
				NO_DEFAULT_PATH
		)

		find_library(OPENSG_SYSTEM_LIBRARY_DEBUG
				NAMES OSGSystemD OSGSystemD.lib OSGSystem OSGSystem.lib libOSGSystemD.so libOSGSystem.so
				PATHS ${OPENSG_LIBRARY_SEARCH_DIRS}
				NO_DEFAULT_PATH
		)

		find_library(OPENSG_BASE_LIBRARY_DEBUG
				NAMES OSGBaseD OSGBaseD.lib OSGBase OSGBase.lib libOSGBaseD.so libOSGBase.so
				PATHS ${OPENSG_LIBRARY_SEARCH_DIRS}
				NO_DEFAULT_PATH
		)
