...
/*                                                                            */
/*============================================================================*/
// $Id: VistaGLLine_Cylinder_geom.glsl 33944 2013-02-18 16:15:38Z jh864363 $
...
{	
	...
	vec3 v4Points[8] = vec3[8](
			gl_in[0].gl_Position.xyz + u_fLineRadius*( -v3X -v3Y -v3Dir ),
			gl_in[0].gl_Position.xyz + u_fLineRadius*( +v3X -v3Y -v3Dir ),
			gl_in[0].gl_Position.xyz + u_fLineRadius*( -v3X +v3Y -v3Dir ),
			gl_in[0].gl_Position.xyz + u_fLineRadius*( +v3X +v3Y -v3Dir ),
			gl_in[1].gl_Position.xyz + u_fLineRadius*( -v3X -v3Y +v3Dir ),
			gl_in[1].gl_Position.xyz + u_fLineRadius*( +v3X -v3Y +v3Dir ),
			gl_in[1].gl_Position.xyz + u_fLineRadius*( -v3X +v3Y +v3Dir ),
			gl_in[1].gl_Position.xyz + u_fLineRadius*( +v3X +v3Y +v3Dir )
		);
