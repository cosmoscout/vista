...
VistaABufferLinkedList::~VistaABufferLinkedList()
{
	if( m_uiHeadPointerBuffer ) glDeleteBuffers( 1, &m_uiHeadPointerBuffer );
	if( m_uiAtomicFragCounter ) glDeleteBuffers( 1, &m_uiAtomicFragCounter );
}
...
bool VistaABufferLinkedList::InitBuffer()
{
	...
	if( !m_uiHeadPointerBuffer ) glGenBuffers( 1, &m_uiHeadPointerBuffer );
	...
	IVistaABuffer::ResizeBuffer(	
		oNextPointerBuffer.m_uiBuffer,
		oNextPointerBuffer.m_addrBuffer, 
...
{
	IVistaABuffer::ResizeBuffer(
		m_uiHeadPointerBuffer, m_addrHeadPointerBuffer, 
		sizeof(unsigned int)*m_uiWidth*m_uiHeight );
}
/******************************************************************************/
...
{
	if( !m_uiAtomicFragCounter   ) glGenBuffers( 1, &m_uiAtomicFragCounter   );
