...
uniform float u_fMaxDepthReplaceFactor = 6; // ca. 1/cos(80°) 
/*============================================================================*/
/* VARYING VARIABLES														  */
/*============================================================================*/
...
out float var_fDepthReplaceFactor;
/*============================================================================*/
/* SHADER MAIN																  */
/*============================================================================*/
void main(void)
{
	...
	// rotate View direction into local space
	...
	// get position relativ to the viwer
	var_v3RelPos = u_v4ViewerPos.xyz - v3Vertex;

	// compute the Depth Replace Factor based on the angle betwen the tublet
	// and the view direction.
	float fCos = dot(in_v3Tangent,v3ViewDir);
	var_fDepthReplaceFactor = clamp(
		(1.0 + in_v2Offset.x) / sqrt(1-(fCos*fCos)),
		0, u_fMaxDepthReplaceFactor);
}
/*============================================================================*/
/* END OF FILE																  */
/*============================================================================*/
