...
class VISTAOGLEXTAPI VistaGeometryRenderingCore {
 public:
  ...
  void SetUsedTextures(
      const std::vector<VistaTexture*>& vecTuextres, bool bTransferOwnership = false);
 ...
 protected:
  ...
  class UniformVariable {
   public:
    UniformVariable(const std::string& strName, unsigned int Components, float f1, float f2 = 0.0f,
