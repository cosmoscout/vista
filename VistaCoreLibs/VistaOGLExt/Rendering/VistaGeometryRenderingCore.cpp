...
void VistaGeometryRenderingCore::SetUsedTextures(
    const std::vector<VistaTexture*>& vecTuextres, bool bTransferOwnership) {
...
void VistaGeometryRenderingCore::SetUniform(
    const std::string& strName, float f1, float f2, float f3) {
  UpdateUniform(UniformVariable(strName, 3, f1, f2, f3));
}
void VistaGeometryRenderingCore::SetUniform(
    const std::string& strName, float f1, float f2, float f3, float f4) {
...
VistaGeometryRenderingCore::UniformVariable::UniformVariable(const std::string& strName,
    unsigned int uiNumComponents, float f1, float f2, float f3, float f4)
    : m_strName(strName)
...
VistaGeometryRenderingCore::UniformVariable::UniformVariable(const std::string& strName, int i)
    : m_strName(strName)
    , m_uiType(0)
    , m_iValue(i) {
}
...
void VistaGeometryRenderingCore::UniformVariable::RefreshUniformForShader(
  ...
  switch (m_uiType) {
  case 0:
    pShader->SetUniform(uiLoc, m_iValue);
    break;
  case 1:
    pShader->SetUniform(uiLoc, m_fValues[0]);
    break;
  case 2:
    pShader->SetUniform(uiLoc, m_fValues[0], m_fValues[1]);
    break;
  case 3:
    pShader->SetUniform(uiLoc, m_fValues[0], m_fValues[1], m_fValues[2]);
    break;
  case 4:
    pShader->SetUniform(uiLoc, m_fValues[0], m_fValues[1], m_fValues[2], m_fValues[3]);
    break;
  }
}
