 ...
 */
class VISTAOGLEXTAPI VistaReferencePlane : public IVistaOpenGLDraw, public IVistaObserver {
 public:
  ...
  // *** Properties ***
  class VISTAOGLEXTAPI VfaReferencePlaneProperties : public IVistaReflectionable {
   public:
