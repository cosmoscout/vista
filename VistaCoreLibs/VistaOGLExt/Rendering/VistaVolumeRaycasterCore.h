...
public:
	...
	virtual bool SetLookupRange( float* pLookupRange, int iRangeId, unsigned int uiNumComponents, unsigned int uiNumVectors );
	virtual bool GetLookupRange( float* pLookupRange, int iRangeId, unsigned int uiNumComponents, unsigned int uiNumVectors ) const;
