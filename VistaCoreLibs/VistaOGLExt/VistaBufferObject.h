...
class VISTAOGLEXTAPI VistaBufferObject {
 public:
   ...
   */
  bool BufferData(GLsizeiptr nSizeInBytes, const void* pData, GLenum eUsage) const;
  /**
   ...
   * @sa BufferData()
   */
  bool BufferSubData(GLintptr iOffset, GLsizeiptr iSize, const void* pData) const;
  /**
   ...
   */
  bool RetrieveBufferSubData(GLintptr iOffset, GLsizeiptr nSizeInBytes, void* pTarget) const;
