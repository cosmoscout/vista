...
class VISTAINTERPROCCOMMAPI VistaByteBufferSerializer : public IVistaSerializer {
 public:
   ...
   * @param iWriteHead can be used to pass an offset in the external buffer, where the serializing
   * shall start
   */
  void SetBuffer(VistaType::byte* pBuffer, int iBufferSize, int iWriteHead = 0);
