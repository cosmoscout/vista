...
class VISTAINTERPROCCOMMAPI VistaConnectionPulsed : public VistaConnection {
 public:
  enum SubConnectionDeleteBehavior { DELETE_SUB_CONNECTION = 0, DO_NOT_DELETE_SUB_CONNECTION };

  VistaConnectionPulsed(VistaConnection* main_connection, unsigned int pulse_distance_in_ms,
      SubConnectionDeleteBehavior sbB = DELETE_SUB_CONNECTION);
