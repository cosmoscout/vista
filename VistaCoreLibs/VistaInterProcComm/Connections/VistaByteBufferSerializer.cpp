...
VistaSerializingToolset::ByteOrderSwapBehavior VistaByteBufferSerializer::GetByteorderSwapFlag() const
{
	return m_bDoSwap;
}


void VistaByteBufferSerializer::SetByteorderSwapFlag( VistaSerializingToolset::ByteOrderSwapBehavior bDoesIt )
{
	m_bDoSwap = bDoesIt;
}
