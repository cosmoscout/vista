...
class VISTAINTERPROCCOMMAPI VistaIPAddress {
 public:
  ...
  /**
   * returns the address-type for this ip-address, which is currently fixed to ipv4
   * addresses.(AF_INET)
   * @return AF_INET
   */
  ...
  /**
   * Returns the "dotted-ip-representation" for this address that can be used for debugging or
   * logging output. Set the hostname to "vrmpc04.rz.rwth-aachen.de" and this string is likely to be
   * something like "134.130.64.204".
