 ...
 * content, since the dispatcher just uses the IVistaSerializable interface. However, for the client
 *side this assumes that the receiving client pipe is currently handling the very same type of data
 *packet. If this were not the case, serious problems (i.e. crashes) will occur upon
 *deserialization.
 *
