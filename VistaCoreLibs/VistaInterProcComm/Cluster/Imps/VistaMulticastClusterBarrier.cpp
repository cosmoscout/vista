...
VistaMulticastClusterLeaderBarrier::VistaMulticastClusterLeaderBarrier(const std::string& sOwnIP,
    const std::string& sMulticastIP, const int nMulticastPort, const bool bVerbose)
...
VistaMulticastClusterLeaderBarrier::VistaMulticastClusterLeaderBarrier(
    VistaMcastSocket* pMulticastSocket, const bool bManageSocketDeletion, const bool bVerbose)
    : VistaClusterLeaderBarrierIPBase(bVerbose) {
...
VistaMulticastClusterFollowerBarrier::VistaMulticastClusterFollowerBarrier(
    const std::string& sMulticastIP, const int nMulticastPort, VistaConnectionIP* pLeaderConnection,
...
VistaMulticastClusterFollowerBarrier::VistaMulticastClusterFollowerBarrier(
    VistaMcastSocket* pMulticastSocket, VistaConnectionIP* pLeaderConn, const bool bManageSocket,
    const bool bManageConnection, const bool bVerbose)
...
bool VistaMulticastClusterFollowerBarrier::BarrierWait(int iTimeOut) {
  ...
  try {
    int nRet =
        m_pMulticastSocket->ReceivefromMulticast(&nReceive, sizeof(VistaType::sint32), iTimeOut);
    if (nRet == 0) {
      if (GetIsVerbose()) {
        vstr::warnp() << "[" << GetBarrierType() << "]: "
