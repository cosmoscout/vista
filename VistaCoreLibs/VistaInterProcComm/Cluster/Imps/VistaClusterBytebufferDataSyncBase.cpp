...
VistaClusterBytebufferLeaderDataSyncBase::VistaClusterBytebufferLeaderDataSyncBase(
    ...
    , m_nSyncCount(0)
    , m_pExtBuffer(NULL) {
  m_oMessage.SetByteorderSwapFlag(
      VistaSerializingToolset::DOES_NOT_SWAP_MULTIBYTE_VALUES); // we never swap
...
bool VistaClusterBytebufferLeaderDataSyncBase::SyncData(
    VistaType::byte* pData, const int iDataSize) {
...
VistaClusterBytebufferFollowerDataSyncBase::VistaClusterBytebufferFollowerDataSyncBase(
    const bool bSwap, const bool bVerbose)
...
bool VistaClusterBytebufferFollowerDataSyncBase::SyncData(
    VistaType::byte* pData, const int iDataSize) {
...
bool VistaClusterBytebufferFollowerDataSyncBase::ReceiveMessage(
    VistaType::sint32 nExpectedMessageType) {
  m_oMessage.ClearBuffer();
