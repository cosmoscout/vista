...
class VISTAINTERPROCCOMMAPI VistaRecordClusterLeaderDataSync : public IVistaClusterDataSync {
 public:
  VistaRecordClusterLeaderDataSync(const std::string& sFilename,
      IVistaClusterDataSync* pOriginalSync, const bool bManageOriginalSyncDeletion = false,
...
class VISTAINTERPROCCOMMAPI VistaReplayClusterFollowerDataSync : public IVistaClusterDataSync {
 public:
  VistaReplayClusterFollowerDataSync(const std::string& sFilename, const bool bVerbose = true);
  VistaReplayClusterFollowerDataSync(VistaConnectionFile* pRecordFile, const bool bVerbose = true);
  ...
  bool GetWaitForSyncTime() const {
    return m_bWaitForSyncTime;
  }
  void SetWaitForSyncTime(const bool& oValue) {
    m_bWaitForSyncTime = oValue;
  }
