...
class VISTABASEAPI VistaSerializingToolset {
 ...
 public:
  ...
  enum ByteOrderSwapBehavior { DOES_NOT_SWAP_MULTIBYTE_VALUES = 0, SWAPS_MULTIBYTE_VALUES = 1 };
  /**
   ...
   * respect to iLength
   * @param iLength either 2,4 or 8 everything else will be ignored IFF iLength is no power of 8,4
   * or 2
