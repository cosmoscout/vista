...
class VISTABASEAPI VistaColor {
 public:
  ...
  enum EFormat { RGB, RGBA, HSL, HSLA, HSV, HSVA, LAB, LABA };
   ...
   */
  VistaColor Mix(
      const VistaColor& colEnd, float fFraction = .5f, EFormat eFormat = VistaColor::RGBA) const;
...
const VistaColor operator+(const VistaColor& oLeft, const VistaColor& oRight);
const VistaColor operator-(const VistaColor& oLeft, const VistaColor& oRight);
...
inline const VistaColor operator+(const VistaColor& oLeft, const VistaColor& oRight) {
...
inline const VistaColor operator*(const VistaColor& oColor, const float fScale) {
  VistaColor oRes(oColor);
  oRes *= fScale;
  return oRes;
}

inline const VistaColor operator*(const float fScale, const VistaColor& oColor) {
...
inline bool operator==(const VistaColor& oLeft, const VistaColor& oRight) {
  return (oLeft[0] == oRight[0] && oLeft[1] == oRight[1] && oLeft[2] == oRight[2] &&
          oLeft[3] == oRight[3]);
}
...
inline std::ostream& operator<<(std::ostream& oStream, const VistaColor& oColor) {
  ...
  // write to the stream
  oStream << "(r:" << oColor[0] << ", g:" << oColor[1] << ", b:" << oColor[2] << ", a:" << oColor[3]
          << ")";
