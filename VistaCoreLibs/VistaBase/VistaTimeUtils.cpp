...
void VistaTimeUtils::ConvertToDate(const VistaType::microtime dTime, int& iMillisecond,
    int& iSecond, int& iMinute, int& iHour, int& iDay, int& iMonth, int& iYear) {
...
std::string VistaTimeUtils::ConvertToFormattedTimeString(
