...
class VISTABASEAPI VistaStreamManager {
 ...
 public:
   ...
   */
  virtual bool AddStream(const std::string& sName, std::ostream& oStream,
      bool bManageDeletion = false, bool bReplaceExistingStream = false);
  /**
   ...
   */
  virtual bool RemoveStream(const std::string& sName, const bool bAlwaysDelete = false);
  /**
  ...
  std::ostream* CreateNewLogFileStream(const std::string& sFileName,
      const std::string& sFileExtension = "log", const bool bManageDeletion = false,
      const bool bAddNodeName = true, const bool bAddTimeStamp = true,
   ...
   */
  bool AddNewLogFileStream(const std::string& sStreamName, const std::string& sFileName = "",
      const std::string& sFileExtension = "log", const bool bAddNodeName = true,
      const bool bAddTimeStamp = true, const bool bAppendToExistingFile = false);
