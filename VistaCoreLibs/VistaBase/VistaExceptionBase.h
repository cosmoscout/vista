...
#define VISTA_THROW(MSG, EXITNUMBER)                                                               \
  {                                                                                                \
    VistaExceptionBase _rexX(MSG, __FILE__, __LINE__, EXITNUMBER);                                 \
    throw _rexX;                                                                                   \
  }
#define VISTA_THROW_NOT_IMPLEMENTED                                                                \
  {                                                                                                \
    VistaExceptionBase _rexX("FUNCTION NOT IMPLEMENTED", __FILE__, __LINE__, -1);                  \
    throw _rexX;                                                                                   \
  }
