...
class VISTABASEAPI VistaTransformMatrix {
 ...
 public:
  ...
  VistaTransformMatrix(const float fVal00, const float fVal01, const float fVal02,
      const float fVal03, const float fVal10, const float fVal11, const float fVal12,
      const float fVal13, const float fVal20, const float fVal21, const float fVal22,
      const float fVal23, const float fVal30, const float fVal31, const float fVal32,
      const float fVal33);
  explicit VistaTransformMatrix(const float a4fRow1[4], const float a4fRow2[4],
      const float a4fRow3[4], const float a4fRow4[4]);
  explicit VistaTransformMatrix(const float a4x4fMatrix[4][4]);
  explicit VistaTransformMatrix(const float a16fValues[16], const bool bColumnMajor = false);
  explicit VistaTransformMatrix(const double a4x4dMatrix[4][4]);
  explicit VistaTransformMatrix(const double a16dValues[16], const bool bColumnMajor = false);
  ...
  void SetToScaleMatrix(const float fXScale, const float fYScale, const float fZScale);

  /**
   * Decomposes the matrix into four components: the translation, rotation,
   * as well as the scale in a local scale rotation
   */
  bool Decompose(VistaVector3D& v3Translation, VistaQuaternion& qRotation, VistaVector3D& v3Scale,
      VistaQuaternion& qScaleRotation) const;
  /**
   * Composes a matrix from the four components: the translation, rotation,
   * as well as the scale in a local scale rotation
   */
  bool Compose(const VistaVector3D& v3Translation, const VistaQuaternion& qRotation,
      const VistaVector3D& v3Scale, const VistaQuaternion& qScaleRotation);
  /**
...
// global operators
inline VistaVector3D operator*(
    const VistaTransformMatrix& matTransform, const VistaVector3D& v3Point);
inline VistaQuaternion operator*(
    const VistaTransformMatrix& matTransform, const VistaQuaternion& qRotation);
inline VistaTransformMatrix operator*(
    const VistaTransformMatrix& matTransform1, const VistaTransformMatrix& matTransform2);
inline VistaTransformMatrix operator+(
    const VistaTransformMatrix& matTransform1, const VistaTransformMatrix& matTransform2);
inline VistaTransformMatrix operator-(
    const VistaTransformMatrix& matTransform1, const VistaTransformMatrix& matTransform2);

inline VistaTransformMatrix operator*(const float fScale, const VistaTransformMatrix& matTransform);
inline VistaTransformMatrix operator*(const VistaTransformMatrix& matTransform, const float fScale);
inline VistaTransformMatrix operator/(const VistaTransformMatrix& matTransform, const float fScale);
...
inline VistaTransformMatrix::VistaTransformMatrix(const float fVal00, const float fVal01,
    const float fVal02, const float fVal03, const float fVal10, const float fVal11,
    const float fVal12, const float fVal13, const float fVal20, const float fVal21,
    const float fVal22, const float fVal23, const float fVal30, const float fVal31,
    const float fVal32, const float fVal33) {
  operator()(0, 0) = fVal00;
  operator()(0, 1) = fVal01;
  operator()(0, 2) = fVal02;
  operator()(0, 3) = fVal03;
...
inline VistaTransformMatrix::VistaTransformMatrix(const float a4fRow0[4], const float a4fRow1[4],
    const float a4fRow2[4], const float a4fRow3[4]) {
  SetRow(0, a4fRow0);
  SetRow(1, a4fRow1);
  SetRow(2, a4fRow2);
  SetRow(3, a4fRow3);
...
inline VistaTransformMatrix::VistaTransformMatrix(
    const float a16fValues[16], const bool bColumnMajor) {
  if (!bColumnMajor)
...
inline VistaTransformMatrix::VistaTransformMatrix(
    const double a16dValues[16], const bool bColumnMajor) {
  if (!bColumnMajor)
...
inline VistaTransformMatrix::VistaTransformMatrix(
    const VistaQuaternion& qRotation, const VistaVector3D& v3Translation) {
...
inline const float& VistaTransformMatrix::operator()(
    const int iRowIndex, const int iColumnIndex) const {
...
inline VistaVector3D VistaTransformMatrix::GetRow(const int iRowIndex) const {
  return VistaVector3D(operator()(iRowIndex, 0), operator()(iRowIndex, 1), operator()(iRowIndex, 2),
                                                                           operator()(
                                                                               iRowIndex, 3));
}
...
inline VistaVector3D VistaTransformMatrix::GetColumn(const int iColumnIndex) const {
  return VistaVector3D(operator()(0, iColumnIndex), operator()(1, iColumnIndex),
...
inline void VistaTransformMatrix::SetValue(
    const int iRowIndex, const int iColumnIndex, const float fValue) {
...
inline void VistaTransformMatrix::GetBasisMatrix(float a9fMatrix[9], const bool bTransposed) const {
  if (bTransposed) {
...
inline void VistaTransformMatrix::SetTransform(
    const VistaQuaternion& qRotation, const VistaVector3D& v3Translation) {
  SetBasisMatrix(qRotation);
  SetTranslation(v3Translation);
  operator()(3, 0) = 0.0f;
...
inline void VistaTransformMatrix::SetToScaleMatrix(
...
inline float VistaTransformMatrix::GetDeterminant() const {
  return (operator()(0, 0) * GetAdjunct(0, 0) + operator()(0, 1) * GetAdjunct(0, 1) +
...
inline VistaTransformMatrix VistaTransformMatrix::GetTranspose() const {
  return VistaTransformMatrix(
      operator()(0, 0), operator()(1, 0), operator()(2, 0), operator()(3, 0), operator()(0, 1),
                                                                              operator()(1, 1),
                                                                              operator()(2, 1),
                                                                              operator()(3, 1),
                                                                              operator()(0, 2),
...
inline VistaTransformMatrix VistaTransformMatrix::Transform(
    const VistaTransformMatrix& matTransform) const {
  VistaTransformMatrix matNew;
  for (int i = 0; i < 4; ++i) {
    for (int j = 0; j < 4; ++j) {
      matNew[i][j] = operator()(i, 0) * matTransform[0][j] + operator()(i, 1) * matTransform[1][j] +
...
inline VistaTransformMatrix& VistaTransformMatrix::operator+=(
    const VistaTransformMatrix& matOther) {
...
inline bool VistaTransformMatrix::operator==(const VistaTransformMatrix& matOther) const {
  return (operator()(0, 0) == matOther[0][0] && operator()(0, 1) == matOther[0][1] &&
                                                operator()(0, 2) == matOther[0][2] &&
                                                operator()(0, 3) == matOther[0][3] &&
                                                operator()(1, 0) == matOther[1][0] &&
                                                operator()(1, 1) == matOther[1][1] &&
...
VistaVector3D operator*(const VistaTransformMatrix& matTransform, const VistaVector3D& v3Point) {
  return matTransform.Transform(v3Point);
}
VistaQuaternion operator*(
    const VistaTransformMatrix& matTransform, const VistaQuaternion& qRotation) {
  return matTransform.Transform(qRotation);
}
VistaTransformMatrix operator*(
    const VistaTransformMatrix& matTransform1, const VistaTransformMatrix& matTransform2) {
...
VistaTransformMatrix operator+(
  ...
  return VistaTransformMatrix(matTransform1[0][0] + matTransform2[0][0],
      matTransform1[0][1] + matTransform2[0][1], matTransform1[0][2] + matTransform2[0][2],
      matTransform1[0][3] + matTransform2[0][3], matTransform1[1][0] + matTransform2[1][0],
      matTransform1[1][1] + matTransform2[1][1], matTransform1[1][2] + matTransform2[1][2],
      matTransform1[1][3] + matTransform2[1][3], matTransform1[2][0] + matTransform2[2][0],
      matTransform1[2][1] + matTransform2[2][1], matTransform1[2][2] + matTransform2[2][2],
      matTransform1[2][3] + matTransform2[2][3], matTransform1[3][0] + matTransform2[3][0],
      matTransform1[3][1] + matTransform2[3][1], matTransform1[3][2] + matTransform2[3][2],
...
VistaTransformMatrix operator*(const float fScale, const VistaTransformMatrix& matTransform) {
  return VistaTransformMatrix(fScale * matTransform[0][0], fScale * matTransform[0][1],
      fScale * matTransform[0][2], fScale * matTransform[0][3], fScale * matTransform[1][0],
      fScale * matTransform[1][1], fScale * matTransform[1][2], fScale * matTransform[1][3],
      fScale * matTransform[2][0], fScale * matTransform[2][1], fScale * matTransform[2][2],
      fScale * matTransform[2][3], fScale * matTransform[3][0], fScale * matTransform[3][1],
      fScale * matTransform[3][2], fScale * matTransform[3][3]);
}
VistaTransformMatrix operator*(const VistaTransformMatrix& matTransform, const float fScale) {
...
std::ostream& operator<<(std::ostream& oStream, const VistaTransformMatrix& matTransform) {
  ...
  // write to the stream
  oStream << "( " << matTransform[0][0] << ", " << matTransform[0][1] << ", " << matTransform[0][2]
          << ", " << matTransform[0][3] << ", " << std::endl
          << "  " << matTransform[1][0] << ", " << matTransform[1][1] << ", " << matTransform[1][2]
          << ", " << matTransform[1][3] << ", " << std::endl
          << "  " << matTransform[2][0] << ", " << matTransform[2][1] << ", " << matTransform[2][2]
          << ", " << matTransform[2][3] << ", " << std::endl
          << "  " << matTransform[3][0] << ", " << matTransform[3][1] << ", " << matTransform[3][2]
          << ", " << matTransform[3][3] << " )";
