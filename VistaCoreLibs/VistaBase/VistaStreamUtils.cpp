...
void vstr::SetStreamManager(VistaStreamManager* pStreamManager, const bool bDeleteOldManager) {
...
std::ostream& vstr::systime(std::ostream& oStream) {
  oStream << std::setw(11) << vstr::formattime(vstr::GetStreamManager()->GetSystemTime());
  return oStream;
}
std::ostream& vstr::relativetime(std::ostream& oStream) {
  oStream << std::setw(14) << vstr::formattime(vstr::GetStreamManager()->GetMicroTime(), 9);
  return oStream;
}
...
std::ostream& vstr::date(std::ostream& oStream) {
  oStream << std::setw(16) << vstr::GetStreamManager()->GetDateString();
  return oStream;
}
std::ostream& vstr::framecount(std::ostream& oStream) {
  oStream << std::setw(8) << vstr::GetStreamManager()->GetFrameCount();
  return oStream;
}
