...
class VISTABASEAPI VistaReferenceFrame {
 public:
  VistaReferenceFrame();
  VistaReferenceFrame(const VistaVector3D& v3RefTranslation, const VistaQuaternion& qRefRotation,
  ...
  bool TransformFromFrame(VistaVector3D& v3Position, VistaQuaternion& qOrientation) const;
  ...
  bool            TransformToFrame(VistaVector3D& v3Position, VistaQuaternion& qOrientation) const;
...
inline VistaReferenceFrame::VistaReferenceFrame(
    const VistaVector3D& refTranslation, const VistaQuaternion& refRotation, float fScale)
...
inline VistaVector3D VistaReferenceFrame::TransformPositionFromFrame(
    const VistaVector3D& v3Position) const {
...
inline VistaQuaternion VistaReferenceFrame::TransformOrientationFromFrame(
    const VistaQuaternion& qOrientation) const {
  return m_qRotation * qOrientation;
}

inline bool VistaReferenceFrame::TransformFromFrame(
    VistaVector3D& v3Position, VistaQuaternion& qOrientation) const {
  v3Position   = TransformPositionFromFrame(v3Position);
  qOrientation = TransformOrientationFromFrame(qOrientation);
  return true;
}

inline VistaTransformMatrix VistaReferenceFrame::TransformMatrixFromFrame(
...
inline VistaVector3D VistaReferenceFrame::TransformPositionToFrame(
    const VistaVector3D& v3Position) const {
...
inline VistaQuaternion VistaReferenceFrame::TransformOrientationToFrame(
    const VistaQuaternion& qOrientation) const {
  return m_qRotation.GetComplexConjugated() * qOrientation;
}

inline bool VistaReferenceFrame::TransformToFrame(
    VistaVector3D& refPosition, VistaQuaternion& refOrientation) const {
  refPosition    = TransformPositionToFrame(refPosition);
  refOrientation = TransformOrientationToFrame(refOrientation);
  return true;
}

inline VistaTransformMatrix VistaReferenceFrame::TransformMatrixToFrame(
    const VistaTransformMatrix& matTransform) {
