 ...
 */
class VISTADEVICEDRIVERSAPI VistaDriverLoggingAspect
 ...
 public:
   ...
   */
  void Log(VistaType::microtime nTimestamp, const IVistaDeviceDriver* pDriver,
      const std::string& strMsg, int nLogLevel = -1);
 ...
 protected:
   ...
   * @todo re-think this!
   */
  virtual bool DoLog(VistaType::microtime nTimestamp, const IVistaDeviceDriver* pDriver,
