...
class VistaDriverPollThread : public VistaThreadLoop {
 public:
   ...
   */
  virtual void PreRun() {
    VistaDriverThreadAspect* ta =
        m_pDriver->GetAspectAs<VistaDriverThreadAspect>(VistaDriverThreadAspect::GetAspectId());
    if (ta->GetThreadOnce())
...
VistaDriverThreadAspect::VistaDriverThreadAspect(
    IVistaDeviceDriver* pDriver, IActivationContext* activation_context)
...
VistaDriverThreadAspect::IDriverUpdatePrepare*
VistaDriverThreadAspect::GetDriverUpdatePrepare() const {
