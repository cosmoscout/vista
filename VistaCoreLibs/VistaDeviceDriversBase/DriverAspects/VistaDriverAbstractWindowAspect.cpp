...
std::list<VistaDriverAbstractWindowAspect::IWindowHandle*> VistaDriverAbstractWindowAspect::GetWindowList() const
{
	if(m_pTouchSeq)
...
//VistaDriverAbstractWindowAspect::IWindowHandle *VistaDriverAbstractWindowAspect::WindowLookup::GetWindowById(int id) const
//{
//	std::set<IWindowHandle*>::const_iterator it = std::find_if( m_windows.begin(), m_windows.end(), _find_by_id<int>( id ) );
//	if( it == m_windows.end() )
//	{
...
//}
//
//VistaDriverAbstractWindowAspect::IWindowHandle VistaDriverAbstractWindowAspect::WindowLookup::GetWindowByHandle(
//		IWindowHandle::OSHANDLE handle) const
//{
//	std::set<IWindowHandle>::const_iterator it = std::find_if( m_windows.begin(), m_windows.end(), _find_by_id<IWindowHandle::OSHANDLE>( handle ) );
//	if( it == m_windows.end() )
//		return IWindowHandle(0, NULL);
//	return (*it);
//}

void VistaDriverAbstractWindowAspect::WindowLookup::RegisterWindow(
		IWindowHandle *window)
{
	m_windows.insert( window );
}

bool VistaDriverAbstractWindowAspect::WindowLookup::UnregisterWindow(
		IWindowHandle *window)
{
...
const VistaDriverAbstractWindowAspect::WindowLookup* VistaDriverAbstractWindowAspect::WindowLookupCollection::GetWindowLookupBySystemTag(
...
VistaDriverAbstractWindowAspect::WindowLookup* VistaDriverAbstractWindowAspect::WindowLookupCollection::UnregisterWindowLookup(
