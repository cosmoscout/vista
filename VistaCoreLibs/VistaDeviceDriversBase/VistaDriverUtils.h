...
class VISTADEVICEDRIVERSAPI VistaDriverPlugin {
 public:
  ...
  IVistaDriverCreationMethod*
                                  m_pMethod; /**< a pointer to the creation methods for drivers of the type */
 ...
 */
bool VISTADEVICEDRIVERSAPI LoadCreationMethodFromPlugin(
    const std::string& strPathToPlugin, VistaDriverPlugin* pStoreTo);

bool VISTADEVICEDRIVERSAPI LoadTranscoderFromPlugin(
    const std::string& strPathToPlugin, VistaDriverPlugin* pStoreTo);
