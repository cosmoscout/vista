...
#define DEFTRANSCODERPLUG_FUNC_EXPORTS(facsym)                                                     \
  ...
  facsym* SpFactory = NULL;                                                                        \
                                                                                                   ...
                                                                                                   \
  extern "C" __declspec(dllexport) IVistaTranscoderFactoryFactory*                                 \
  CreateTranscoderFactoryFactory() {                                                               \
    if (!SpFactory)                                                                                \
      SpFactory = new facsym;                                                                      \
                                                                                                   \
    IVistaReferenceCountable::refup(SpFactory);                                                    \
    ...
    return SpFactory;                                                                              \
                                                                                                   ...
                                                                                                   \
  extern "C" __declspec(dllexport) bool OnUnloadTranscoderFactoryFactory(                          \
...
#define DEFTRANSCODERPLUG_FUNC_IMPORTS(facsym)                                                     \
  ...
  facsym* SpFactory = NULL;                                                                        \
                                                                                                   ...
                                                                                                   \
  extern "C" __declspec(dllimport) IVistaTranscoderFactoryFactory*                                 \
  CreateTranscoderFactoryFactory() {                                                               \
    if (!SpFactory)                                                                                \
      SpFactory = new facsym;                                                                      \
                                                                                                   \
    ...
    return SpFactory;                                                                              \
                                                                                                   ...
                                                                                                   \
  extern "C" __declspec(dllimport) bool OnUnloadTranscoderFactoryFactory(                          \
      IVistaTranscoderFactoryFactory* fac)                                                         \
                                                                                                   \
  {                                                                                                \
    if (!SpFactory)                                                                                \
...
#define IMPTRANSCODERPLUG_CLEANUP(facsym)                                                          \
  static void releaseTranscoders() {                                                               \
    facsym::OnUnload();                                                                            \
  }                                                                                                \
                                                                                                   \
