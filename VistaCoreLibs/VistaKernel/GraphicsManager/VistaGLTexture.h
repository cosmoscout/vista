...
class VISTAKERNELAPI VistaGLTexture : public IVistaSharedCoreOwner {
 ...
 public:
  ...
  bool Set1DData(const int nWidth, const VistaType::byte* pData, const bool bGenMipmaps = true,
      const GLenum eInternalFormat = GL_RGB, const GLenum ePixelFormat = GL_RGB,
      const GLenum eDataFormat = GL_UNSIGNED_BYTE);
  bool Set2DData(const int nWidth, const int nHeight, const VistaType::byte* pData,
      const bool bGenMipmaps = true, const GLenum eInternalFormat = GL_RGB,
      const GLenum ePixelFormat = GL_RGB, const GLenum eDataFormat = GL_UNSIGNED_BYTE,
  ...
  bool Set3DData(const int nWidth, const int nHeight, const int nDepth,
      ...
      const GLenum eInternalFormat = GL_RGB, const GLenum ePixelFormat = GL_RGB,
      const GLenum eDataFormat = GL_UNSIGNED_BYTE);
  bool SetData(const VistaImage& oImage, const bool bGenMipmaps = true,
...
class VISTAKERNELAPI IVistaTextureCore : public IVistaSharedCore {
 public:
  ...
  virtual bool Set1DData(const int nWidth, const VistaType::byte* pData,
      ...
      const GLenum ePixelFormat = GL_RGBA, const GLenum eDataFormat = GL_UNSIGNED_BYTE) = 0;
  ...
  virtual bool SetData(const VistaImage& oImage, const bool bGenMipmaps = true,
      const GLenum eInternalFormat = GL_RGBA)                                           = 0;
  // @IMAGETODO: option to query image that has set the data?
