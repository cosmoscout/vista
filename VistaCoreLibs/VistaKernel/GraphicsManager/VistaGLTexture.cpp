...
bool VistaGLTexture::Set1DData( const int nWidth, const VistaType::byte* pData, const bool bGenMipmaps /*= true*/, const GLenum eInternalFormat /*= GL_RGBA*/, const GLenum ePixelFormat /*= GL_RGBA*/, const GLenum eDataFormat /*= GL_UNSIGNED_BYTE */ )
{
	return GetCoreForWriting()->Set1DData( nWidth, pData, bGenMipmaps, eInternalFormat, ePixelFormat, eDataFormat );
}

bool VistaGLTexture::Set2DData( const int nWidth, const int nHeight, const VistaType::byte* pData, const bool bGenMipmaps /*= true*/, const GLenum eInternalFormat /*= GL_RGBA*/, const GLenum ePixelFormat /*= GL_RGBA*/, const GLenum eDataFormat /*= GL_UNSIGNED_BYTE */, const GLuint nMultiSampleNum )
{
	return GetCoreForWriting()->Set2DData( nWidth, nHeight, pData, bGenMipmaps, eInternalFormat, ePixelFormat, eDataFormat );
}

bool VistaGLTexture::Set3DData( const int nWidth, const int nHeight, const int nDepth, const VistaType::byte* pData, const bool bGenMipmaps /*= true*/, const GLenum eInternalFormat /*= GL_RGBA*/, const GLenum ePixelFormat /*= GL_RGBA*/, const GLenum eDataFormat /*= GL_UNSIGNED_BYTE */ )
{
	return GetCoreForWriting()->Set3DData( nWidth, nHeight, nWidth, pData, bGenMipmaps, eInternalFormat, ePixelFormat, eDataFormat );
}

bool VistaGLTexture::SetData( const VistaImage& oImage, const bool bGenMipmaps, const GLenum eInternalFormat )
{
