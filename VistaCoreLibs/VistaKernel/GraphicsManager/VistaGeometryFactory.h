...
class VISTAKERNELAPI VistaGeometryFactory {
 public:
   ...
   */
  VistaGeometry* CreatePlane(float nSizeX = 1, float nSizeZ = 1, int nResolutionX = 1,
      int nResolutionZ = 1, Vista::AXIS eNormalDirection = Vista::Y,
      VistaColor oColor = VistaColor::WHITE, FaceType eFaceType = FT_TRIANGLE,
   ...
   */
  static bool CreatePlaneData(vector<VistaIndexedVertex>* pIndex, vector<float>* pCoords,
      vector<float>* pTexCoords, vector<float>* pNormals, vector<VistaColor>* pColors,
      VistaGeometry::FaceType* pFaceType, float nSizeX = 1, float nSizeZ = 1,
      int nResolutionX = 1.0f, int nResolutionZ = 1.0f, Vista::AXIS eNormalDirection = Vista::Y,
      VistaColor oColor = VistaColor::WHITE, FaceType eFaceType = FT_TRIANGLE,
      float nMinTextureCoordX = 0.0f, float nMaxTextureCoordX = 1.0f,
      float nMinTextureCoordZ = 0.0f, float nMaxTextureCoordZ = 1.0f);
   ...
   * @param pFaceType  Pointer to VistaGeometry face type.
   */
  static bool CreateBoxData(vector<VistaIndexedVertex>* pIndex, vector<float>* pCoords,
      vector<float>* pTexCoords, vector<float>* pNormals, vector<VistaColor>* pColors,
      VistaGeometry::FaceType* pFaceType, float nSizeX = 1.0f, float nSizeY = 1.0f,
      float nSizeZ = 1.0f, int nResolutionX = 1, int nResolutionY = 1, int nResolutionZ = 1,
      VistaColor oColor = VistaColor::WHITE, FaceType eFaceType = FT_TRIANGLE,
      float nMinTextureCoordX = 0.0f, float nMaxTextureCoordX = 1.0f,
      float nMinTextureCoordY = 0.0f, float nMaxTextureCoordY = 1.0f,
      float nMinTextureCoordZ = 0.0f, float nMaxTextureCoordZ = 1.0f);
   ...
   */
  VistaGeometry* CreateDisk(float radius = 0.5f, int resC = 16, int resD = 1,
      Vista::AXIS normal = Vista::Y, VistaColor color = VistaColor::WHITE);
   ...
   * @param pColors    Pointer to vertex colors vector.
   */
  static bool CreateDiskData(vector<VistaIndexedVertex>* pIndex, vector<float>* pCoords,
      vector<float>* pTexCoords, vector<float>* pNormals, vector<VistaColor>* pColors,
      float radius = 0.5f, int resC = 16, int resD = 1, Vista::AXIS normal = Vista::Y,
   ...
   */
  VistaGeometry* CreateCone(float radiusBottom = 0.5f, float radiusTop = 0.5f, float height = 1.0f,
      int resolutionC = 16, int resolutionD = 1, int resolutionY = 1,
      VistaColor color = VistaColor::WHITE, bool bottom = true, bool top = true, bool sides = true);
   ...
   * @param pColors    Pointer to vertex colors vector.
   */
  static bool CreateConeData(vector<VistaIndexedVertex>* pIndex, vector<float>* pCoords,
      vector<float>* pTexCoords, vector<float>* pNormals, vector<VistaColor>* pColors,
      float botRad = 0.5f, float topRad = 0.5f, float height = 1.0f, int resC = 16, int resD = 1,
      int resY = 1, VistaColor color = VistaColor::WHITE, bool bBottom = true, bool bTop = true,
      bool bSides = true);
   ...
   */
  VistaGeometry* CreateTorus(float ringRadius = 0.1f, float outerRadius = 0.4f,
      int resolutionSides = 30, int resolutionRing = 30, VistaColor color = VistaColor::WHITE);
   ...
   * @param pColors    Pointer to vertex colors vector.
   */
  static bool CreateTorusData(float innerRad, float outerRad, int resSides, int resRings,
      VistaColor color, vector<VistaIndexedVertex>* pIndex, vector<float>* pCoords,
      vector<float>* pTexCoords, vector<float>* pNormals, vector<VistaColor>* pColors);
   ...
   */
  VistaGeometry* CreateEllipsoid(float radius_a = 0.5f, float radius_b = 0.5f,
      float radius_c = 0.5f, int thetaPrecision = 32, int phiPrecision = 32,
   ...
   * @param pColors    Pointer to vertex colors vector.
   */
  static bool CreateEllipsoidData(vector<VistaIndexedVertex>* pIndex,
      vector<VistaVector3D>* pCoords, vector<VistaVector3D>* pTexCoords,
      vector<VistaVector3D>* pNormals, vector<VistaColor>* pColors, float radius_a = 0.5f,
      float radius_b = 0.5f, float radius_c = 0.5f, int thetaPrecision = 32, int phiPrecision = 32,
      const VistaColor& color = VistaColor::WHITE);
  ...
  VistaGeometry* CreateSphere(
      float radius = 0.5f, int resolution = 32, VistaColor color = VistaColor::WHITE);
   ...
   * @param pColors    Pointer to vertex colors vector.
   */
  static bool CreateSphereData(std::vector<VistaIndexedVertex>* pIndex,
      std::vector<VistaVector3D>* pCoords, std::vector<VistaVector3D>* pTexCoords,
      std::vector<VistaVector3D>* pNormals, std::vector<VistaColor>* pColors, float radius,
      int resolution, const VistaColor& color);
   ...
   * @parma color Ellipsoid color.
   */
  VistaGeometry* CreateTriangle(const VistaVector3D& a = VistaVector3D(-1.0f / 2, -1.0f / 2, 0),
      const VistaVector3D&                           b = VistaVector3D(1.0f / 2, -1.0f / 2, 0),
      const VistaVector3D& c = VistaVector3D(0, 1.0f / 2, 0), int resolution = 3,
      const VistaColor& color = VistaColor::WHITE);
   ...
   * @param pColors    Pointer to vertex colors vector.
   */
  static bool CreateTriangleData(const VistaVector3D& a, const VistaVector3D& b,
