...
class VISTAKERNELAPI VistaDisplayManager : public VistaEventHandler {
 public:
   ...
   */
  bool CreateDisplaySystems(const std::string& sIniSection, const VistaPropertyList& oConfig);
   ...
   */
  virtual VistaDisplaySystem* CreateDisplaySystem(
  ...
  virtual VistaProjection* CreateProjection(
      VistaViewport* pViewport, const std::string& sIniSection, const VistaPropertyList& oProps);
   ...
   */
  bool RenameDisplaySystem(const std::string& sOldName, const std::string& sNewName);
  bool RenameViewport(const std::string& sOldName, const std::string& sNewName);
  bool RenameProjection(const std::string& sOldName, const std::string& sNewName);
  bool RenameWindow(const std::string& sOldName, const std::string& sNewName);
  bool RenameDisplay(const std::string& sOldName, const std::string& sNewName);
   ...
   */
  bool MakeScreenshot(VistaWindow* pWindow, const std::string& sFilename) const;
  bool MakeScreenshot(const std::string& sWindowName, const std::string& sFilename) const;
  ...
  bool AddSceneOverlay(IVistaSceneOverlay* pOverlay, const std::string& sViewportName = "");
  bool AddSceneOverlay(IVistaSceneOverlay* pOverlay, VistaViewport* pViewport);
  bool RemSceneOverlay(IVistaSceneOverlay* pOverlay, const std::string& sViewportName = "");
  bool RemSceneOverlay(IVistaSceneOverlay* pOverlay, VistaViewport* pViewport);
