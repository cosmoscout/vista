...
public:
	...
	virtual bool GetWindowRGBImage( const VistaWindow* pWindow, std::vector< VistaType::byte >& vecData ) const = 0;
	virtual int GetWindowRGBImage( const VistaWindow* pWindow, VistaType::byte* pData, const int nBufferSize ) const = 0;
	virtual bool GetWindowDepthImage( const VistaWindow* pWindow, std::vector< VistaType::byte >& vecData ) const = 0;
	virtual int GetWindowDepthImage( const VistaWindow* pWindow, VistaType::byte* pData, const int nBufferSize ) const = 0;
	...
	virtual VistaViewport::VistaViewportProperties::ViewportType GetViewportType( const VistaViewport* pTarget ) = 0;
	virtual bool SetViewportType( VistaViewport::VistaViewportProperties::ViewportType eType, VistaViewport* pTarget ) = 0;
	...
	virtual bool SetViewportPostProcessShaderFile( const std::string& sShader, VistaViewport* pTarget ) = 0;
	...
	virtual bool MakeScreenshot( const VistaWindow& pWindow,
									const std::string& strFilename ) const = 0;
