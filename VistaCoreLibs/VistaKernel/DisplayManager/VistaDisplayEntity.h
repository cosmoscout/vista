...
{
 public:
  enum EPropertyStatus { PROP_OK, PROP_NOT_FOUND, PROP_INVALID_VALUE, PROP_READ_ONLY };
...
class TVistaDisplayEntityParentPropertyGet : public IVistaPropertyGetFunctor {
 public:
  /**
   ...
   */
  TVistaDisplayEntityParentPropertyGet(const std::string& sPropName, const std::string& sClassType,
      R (P::*pfm)() const, const std::string& sDescription = "")
