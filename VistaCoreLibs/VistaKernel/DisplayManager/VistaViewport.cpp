...
/*============================================================================*/
VistaViewport::VistaViewport(VistaDisplaySystem* pDisplaySystem, VistaWindow* pWindow,
...
void VistaViewport::Debug(std::ostream& out) const {
  ...
  out << vstr::indent << "[VistaViewport]      - name                   : " << GetNameForNameable()
      << std::endl;

  int x, y;
  GetViewportProperties()->GetPosition(x, y);
  out << vstr::indent << "[VistaViewport]      - position               : " << x << " / " << y
      << std::endl;

  GetViewportProperties()->GetSize(x, y);
  out << vstr::indent << "[VistaViewport]      - size                   : " << x << " / " << y
      << std::endl;
...
IVistaPropertyGetFunctor* aCgFunctorsVV[] = {
    ...
    new TVistaProperty2RefGet<int, VistaViewport::VistaViewportProperties,
    ...
    new TVistaProperty2RefGet<int, VistaViewport::VistaViewportProperties,
        VistaProperty::PROPT_INT>("TEXTURE_SIZE", sSReflectionTypeVV,
        &VistaViewport::VistaViewportProperties::GetTextureSize),
    ...
    new TVistaPropertyGet<std::string, VistaViewport::VistaViewportProperties,
        VistaProperty::PROPT_STRING>(
        "TYPE", sSReflectionTypeVV, &VistaViewport::VistaViewportProperties::GetTypeString),
    new TVistaPropertyGet<std::string, VistaViewport::VistaViewportProperties,
        VistaProperty::PROPT_STRING>("POSTPROCESS_SHADER", sSReflectionTypeVV,
        &VistaViewport::VistaViewportProperties::GetPostProcessShaderFile),
    new TVistaPropertyGet<bool, VistaViewport::VistaViewportProperties, VistaProperty::PROPT_BOOL>(
        "RESIZE_WITH_WINDOW", sSReflectionTypeVV,
        &VistaViewport::VistaViewportProperties::GetResizeWithWindow),
    new TVistaPropertyGet<bool, VistaViewport::VistaViewportProperties, VistaProperty::PROPT_BOOL>(
        "REPOSITION_WITH_WINDOW", sSReflectionTypeVV,
        &VistaViewport::VistaViewportProperties::GetRepositionWithWindow),
    new TVistaDisplayEntityParentPropertyGet<std::string, VistaViewport,
        VistaProperty::PROPT_STRING>(
...
IVistaPropertySetFunctor* aCsFunctorsVV[] = {
    ...
    new TVistaProperty2ValSet<int, VistaViewport::VistaViewportProperties>("TEXTURE_SIZE",
        sSReflectionTypeVV, &VistaViewport::VistaViewportProperties::SetTextureSize),
    ...
    new TVistaPropertySet<const string&, string, VistaViewport::VistaViewportProperties>(
        "POSTPROCESS_SHADER", sSReflectionTypeVV,
        &VistaViewport::VistaViewportProperties::SetPostProcessShaderFile),
    new TVistaPropertySet<bool, bool, VistaViewport::VistaViewportProperties>("RESIZE_WITH_WINDOW",
        sSReflectionTypeVV, &VistaViewport::VistaViewportProperties::SetResizeWithWindow),
    new TVistaPropertySet<bool, bool, VistaViewport::VistaViewportProperties>(
        "REPOSITION_WITH_WINDOW", sSReflectionTypeVV,
        &VistaViewport::VistaViewportProperties::SetRepositionWithWindow),
...
VistaViewport::VistaViewportProperties::ViewportType
VistaViewport::VistaViewportProperties::GetType() const {
...
VistaViewport::VistaViewportProperties::VistaViewportProperties(
    VistaDisplayEntity* pParent, IVistaDisplayBridge* pDisplayBridge)
...
std::string VistaViewport::VistaViewportProperties::GetStringForViewportType(
    const ViewportType eType) {
  switch (eType) {
  case VT_MONO:
    return "MONO";
...
VistaViewport::VistaViewportProperties::ViewportType
VistaViewport::VistaViewportProperties::GetViewportTypeFromString(const std::string& sType) {
  ...
  } else if (oCompare(sType, "POSTPROCESS_QUADBUFFERED_STEREO") ||
             oCompare(sType, "POSTPROCESS_QUADBUFFER_STEREO")) {
