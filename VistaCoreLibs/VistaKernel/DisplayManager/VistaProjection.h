 ...
 public:
  ...
  class VISTAKERNELAPI VistaProjectionProperties : public IVistaDisplayEntityProperties {
   public:
    ...
    enum EStereoMode { SM_MONO, SM_LEFT_EYE, SM_RIGHT_EYE, SM_FULL_STEREO };
     ...
     */
    bool SetProjectionPlane(const VistaVector3D& v3MidPoint, const VistaVector3D& v3NormalVector,
   ...
   private:
    VistaProjectionProperties(VistaProjection*, IVistaDisplayBridge*);
