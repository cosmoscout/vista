...
/*============================================================================*/
VistaOpenSGImageAndTextureCoreFactory::VistaOpenSGImageAndTextureCoreFactory( osg::RenderAction* pAction )
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::LoadFromFile( const std::string& sFilename )
{
	...
	{
		vstr::warnp() << "OpenSGImage::LoadFromFile() -- Image file \"" << sFilename << "\" does not exist" << std::endl;
		return false;
	}
	...
	{
		vstr::warnp() << "OpenSGImage::LoadFromFile() -- Loading of file \"" << sFilename << "\" failed" << std::endl;
		return false;
	}
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::WriteToFile( const std::string& sFilename ) const
{
	if( m_pImage == osg::NullFC )
		return false;
	if( m_pImage->write( sFilename.c_str() ) == false )
	{
		vstr::warnp() << "OpenSGImage::WriteToFile() -- Writing file \"" << sFilename << "\" failed" << std::endl;
		return false;
	}
	return true;
}

bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::Set1DData( const int nWidth, VistaType::byte* pData, const GLenum ePixelFormat, const GLenum ePixelDataType, const bool bCopyData )
{
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::Set2DData( const int nWidth, const int nHeight, VistaType::byte* pData, const GLenum ePixelFormat, const GLenum ePixelDataType, const bool bCopyData )
{
	osg::UInt32 nPixelFormat = ePixelFormat;	
	osg::UInt32 nComponentFormat = ePixelDataType;
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::Set3DData( const int nWidth, const int nHeight, const int nDepth, VistaType::byte* pData, const GLenum ePixelFormat, const GLenum ePixelDataType, const bool bCopyData )
{
	osg::UInt32 nPixelFormat = ePixelFormat;	
	osg::UInt32 nComponentFormat = ePixelDataType;
	...
	pNewImage = osg::Image::create();
	beginEditCP( pNewImage );
	pNewImage->set( nPixelFormat, nWidth, nHeight, nDepth, 1, 1, 0.0, pData, nComponentFormat, true, 1 );
	endEditCP( pNewImage );
	m_pImage = pNewImage;
	return true;
}
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::Rescale( const unsigned int nNewWidth, const unsigned int nNewHeight )
{
	if( m_pImage == osg::NullFC )
		return false;
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::Crop( const unsigned int nBottomLeftX, const unsigned int nBottomLeftY, const unsigned int nNewWidth, const unsigned int nNewHeight )
{
	if( m_pImage == osg::NullFC )
		return false;
...
bool VistaOpenSGImageAndTextureCoreFactory::ImageCore::ReformatImage( const GLenum eNewFormat, const GLenum ePixelDataType )
{
	if( m_pImage == osg::NullFC )
		return false;
...
bool VistaOpenSGImageAndTextureCoreFactory::TextureCore::Set1DData( const int nWidth, const VistaType::byte* pData, const bool bGenMipmaps /*= true*/, const GLenum eInternalFormat /*= GL_RGBA*/, const GLenum ePixelFormat /*= GL_RGBA*/, const GLenum eDataFormat /*= GL_UNSIGNED_BYTE */ )
{
	VISTA_THROW_NOT_IMPLEMENTED;
}

bool VistaOpenSGImageAndTextureCoreFactory::TextureCore::Set2DData( const int nWidth, const int nHeight, const VistaType::byte* pData, const bool bGenMipmaps /*= true*/, const GLenum eInternalFormat /*= GL_RGBA*/, const GLenum ePixelFormat /*= GL_RGBA*/, const GLenum eDataFormat /*= GL_UNSIGNED_BYTE */, const int nNumMultisamples )
{
	// @IMGTODO: multisample?
...
bool VistaOpenSGImageAndTextureCoreFactory::TextureCore::Set3DData( const int nWidth, const int nHeight, const int nDepth, const VistaType::byte* pData, const bool bGenMipmaps /*= true*/, const GLenum eInternalFormat /*= GL_RGBA*/, const GLenum ePixelFormat /*= GL_RGBA*/, const GLenum eDataFormat /*= GL_UNSIGNED_BYTE */ )
{
	VISTA_THROW_NOT_IMPLEMENTED;
}

bool VistaOpenSGImageAndTextureCoreFactory::TextureCore::SetData( const VistaImage& oImage, const bool bGenMipmaps, const GLenum eInternalFormat )
{
