...
#ifdef DEBUG
				vstr::errp() << "VistaOpenSGGraphicsBridge::GetColor() -- "
						<< " found no MaterialChunk and no SimpleMaterial - cannot retrieve color" << std::endl;
#endif
				return VistaColor(VistaColor::RED);
			}
...
bool VistaOpenSGGraphicsBridge::GetTrianglesTextureCoordinateIndices( std::vector<int>& vecTexCoordIndices,
									const IVistaGeometryData* pData ) const
{
	 const VistaOpenSGGeometryData* pOpenSGData 
						= static_cast<const VistaOpenSGGeometryData*>(pData);
...
bool VistaOpenSGGraphicsBridge::GetTextureCoords2D( std::vector<float>& vecTexCoords, const IVistaGeometryData* pData ) const
{
	/** @todo why 2D TexCoords into VistaVector3D? */
...
bool VistaOpenSGGraphicsBridge::GetColors( std::vector<float>& vecColors, const IVistaGeometryData* pData ) const
{
	const VistaOpenSGGeometryData* pOpenSGData 
						= static_cast<const VistaOpenSGGeometryData*>(pData);
	osg::GeometryPtr geo = pOpenSGData->GetGeometry();
...
IVistaGeometryData* VistaOpenSGGraphicsBridge::CloneGeometryData( const IVistaGeometryData* pGeomData ) const
{
	const VistaOpenSGGeometryData* pOpenSGData = static_cast< const VistaOpenSGGeometryData* >( pGeomData );
