...
class VISTAKERNELAPI VistaOpenSGDisplayBridge : public IVistaDisplayBridge {
 public:
  ...
  VistaOpenSGDisplayBridge(osg::RenderAction* pRenderAction, osg::NodePtr pRealRoot);
  ...
  virtual void DebugDisplaySystem(std::ostream& oStream, VistaDisplaySystem* pTarget);
  virtual void SetViewerPosition(const VistaVector3D& v3Pos, VistaDisplaySystem* pTarget);
  virtual void GetViewerPosition(VistaVector3D& v3Pos, const VistaDisplaySystem* pTarget);
  virtual void SetViewerOrientation(const VistaQuaternion& qOrient, VistaDisplaySystem* pTarget);
  virtual void GetViewerOrientation(VistaQuaternion& qOrient, const VistaDisplaySystem* pTarget);
  virtual void SetEyeOffsets(const VistaVector3D& v3LeftOffset, const VistaVector3D& v3RightOffset,
      VistaDisplaySystem* pTarget);
  virtual void GetEyeOffsets(
      VistaVector3D& v3LeftOffset, VistaVector3D& v3RightOffset, const VistaDisplaySystem* pTarget);
  virtual void SetLocalViewer(bool bLocalViewer, VistaDisplaySystem* pTarget);
  ...
  virtual VistaWindow* CreateVistaWindow(VistaDisplay* pDisplay, const VistaPropertyList& refProps);
  virtual bool         DestroyVistaWindow(VistaWindow* pWindow);
  virtual bool         SetWindowStereo(bool bStereo, VistaWindow* pTarget);
  virtual bool         GetWindowStereo(const VistaWindow* pTarget);
  virtual bool         SetWindowAccumBufferEnabled(bool bAccumBufferEnabled, VistaWindow* pTarget);
  virtual bool         GetWindowAccumBufferEnabled(const VistaWindow* pTarget);
  virtual bool SetWindowStencilBufferEnabled(bool bStencilBufferEnabled, VistaWindow* pTarget);
  ...
  virtual bool SetWindowDrawBorder(bool bDrawBorder, VistaWindow* pTarget);
  virtual bool SetWindowPosition(int nXPos, int nYPos, VistaWindow* pTarget);
  virtual bool GetWindowPosition(int& nXPos, int& nYPos, const VistaWindow* pTarget);
  virtual bool SetWindowSize(int nWidth, int nHeight, VistaWindow* pTarget);
  virtual bool GetWindowSize(int& nWidth, int& nHeight, const VistaWindow* pTarget);
  virtual bool SetWindowVSync(bool bEnabled, VistaWindow* pTarget);
  virtual int  GetWindowVSync(const VistaWindow* pTarget);
  virtual bool SetWindowFullScreen(bool bFullScreen, VistaWindow* pTarget);
  ...
  virtual bool GetWindowContextVersion(int& nMajor, int& nMinor, const VistaWindow* pTarget) const;
  virtual bool SetWindowContextVersion(int nMajor, int nMinor, VistaWindow* pTarget);
  virtual bool GetWindowIsDebugContext(const VistaWindow* pTarget) const;
  virtual bool SetWindowIsDebugContext(const bool bIsDebug, VistaWindow* pTarget);
  virtual bool GetWindowIsForwardCompatible(const VistaWindow* pTarget) const;
  virtual bool SetWindowIsForwardCompatible(const bool bIsForwardCompatible, VistaWindow* pTarget);
  virtual int  GetWindowId(const VistaWindow* pTarget);
  virtual bool SetWindowTitle(const std::string& strTitle, VistaWindow* pTarget);
  virtual std::string GetWindowTitle(const VistaWindow* pTarget);
  virtual void        DebugVistaWindow(std::ostream& oStream, const VistaWindow* pTarget);
  virtual bool        RenderWindow(VistaWindow* pWindow);

  /**
   * Methods for viewport management.
   */
  virtual VistaViewport* CreateViewport(
  ...
  virtual void GetProjPlaneExtents(
      double& dLeft, double& dRight, double& dBottom, double& dTop, const VistaProjection* pTarget);
  virtual void SetProjClippingRange(double dNear, double dFar, VistaProjection* pTarget);
  virtual void GetProjClippingRange(double& dNear, double& dFar, const VistaProjection* pTarget);
  ...
  virtual bool MakeScreenshot(const VistaWindow& pWindow, const std::string& strFilename) const;
  ...
  virtual bool Get2DOverlay(const std::string& strWindowName, std::list<Vista2DDrawingObject*>&);

  virtual bool AddSceneOverlay(IVistaSceneOverlay* pDraw, VistaViewport* pViewport);
  virtual bool RemSceneOverlay(IVistaSceneOverlay* pDraw, VistaViewport* pViewport);
  ...
  class VISTAKERNELAPI ViewportData : public IVistaDisplayEntityData {
   ...
   public:
    ...
    void SetPriority(const int oValue) {
      m_nPriority = oValue;
    }
    VistaViewport::VistaViewportProperties::ViewportType GetType() const {
      return m_eType;
    }
    void SetType(const VistaViewport::VistaViewportProperties::ViewportType oValue) {
      m_eType = oValue;
    }
  ...
  class VISTAKERNELAPI ProjectionData : public IVistaDisplayEntityData {
   ...
   public:
    ...
    void SetCameraTransformation(const VistaVector3D& v3CamPos, const VistaQuaternion& qCamOri);

    void          GetCameraTransformation(VistaVector3D& v3CamPos, VistaQuaternion& qCamOri) const;
  ...
  class VISTAKERNELAPI VistaOpenSG2DBitmap : public Vista2DBitmap {
   public:
    VistaOpenSG2DBitmap(IVistaDisplayBridge* pBr, const std::string& sVpName);
 ...
 private:
  ...
  void        FillRenderInfo(VistaViewport* pViewport, osg::ViewportPtr pOsgViewport) const;
  void        FillRenderInfo(VistaViewport* pViewport, osg::ViewportPtr pOsgViewport,
