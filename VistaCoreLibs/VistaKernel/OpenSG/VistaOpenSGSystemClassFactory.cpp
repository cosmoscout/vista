...
, m_pVistaSystem( pVistaSystem )
{
	...
	IVistaImageAndTextureCoreFactory::SetSingleton( new VistaOpenSGImageAndTextureCoreFactory( m_pRenderAction ) );
}
...
VistaDisplayManager* VistaOpenSGSystemClassFactory::CreateDisplayManager()
{
	...
	VistaOpenSGDisplayBridge * pDisplayBridge =	new VistaOpenSGDisplayBridge(m_pRenderAction, pOSGRoot);
