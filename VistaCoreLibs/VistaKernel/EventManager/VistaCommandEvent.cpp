...
int VistaCommandEvent::Serialize(IVistaSerializer& rSer) const {
  ...
  iRet += VistaPropertyList::SerializePropertyList(
      rSer, m_mpPropertyList, "VistaCommandEvent.m_mpPropertyList");
  return iRet;
}
...
bool VistaCommandEvent::SetPropertyByName(const string& sPropName, const string& sPropValue) {
