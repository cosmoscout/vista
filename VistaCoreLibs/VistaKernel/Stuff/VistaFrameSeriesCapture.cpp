...
void VistaFrameSeriesCapture::ReplaceDate( std::string& sName, const VistaType::microtime nTime )
{
	...
	m_bNeedsDateReplace = StringReplace( sName, "%D%", sDateString ) ||  StringReplace( sName, "$D$", sDateString );
}
...
void VistaFrameSeriesCapture::ReplaceTime( std::string& sName, const VistaType::microtime nTime )
{
	...
	m_bNeedsTimeReplace = ( StringReplace( sName, "%T%", sTimeString ) || StringReplace( sName, "$T$", sTimeString ) );
}
...
void VistaFrameSeriesCapture::ReplaceMilliSeconds( std::string& sName, const VistaType::microtime nTime )
{
	...
	m_bNeedsMilliReplace = ( StringReplace( sName, "%M%", sMilliString ) || StringReplace( sName, "$M$", sMilliString ) );
}
...
void VistaFrameSeriesCapture::ReplaceFrameCount( std::string& sName )
{
	...
	m_bNeedsFrameReplace = ( StringReplace( sName, "%F%", sCountString ) || StringReplace( sName, "$F$", sCountString ) );
}
...
void VistaFrameSeriesCapture::ReplaceScreenshotCount( std::string& sName )
{
	...
	m_bNeedsScreenshotReplace = ( StringReplace( sName, "%S%", sCountString ) || StringReplace( sName, "$S$", sCountString ) );
}
