...
class VISTAKERNELAPI IVistaProximityWarningBase : public VistaEventObserver {
 public:
  ...
  bool Update(const VistaVector3D& v3ViewerPosition, const VistaQuaternion& qViewerOrientation);
  bool Update(const VistaVector3D& v3ViewerPosition, const VistaQuaternion& qViewerOrientation,
 ...
 protected:
  ...
  virtual bool DoTimeUpdate(
      VistaType::systemtime nTime, const float nOpacityScale, const bool bFlashState) = 0;
 ...
 private:
  ...
  void UpdateFromExtents(
      const VistaVector3D& v3UserPosition, float& fDistance, VistaVector3D& v3ClostestPoint);
  void UpdateFromHalfplane(const HalfPlane& oPlane, const VistaVector3D& v3UserPosition,
      float& fDistance, VistaVector3D& v3ClostestPoint);
