...
class VistaUserPlatform::UserObserver : public IVistaObserver {
 public:
  ...
  virtual bool Observes(IVistaObserveable* pObserveable) {
    return (
        dynamic_cast<VistaDisplaySystem::VistaDisplaySystemProperties*>(pObserveable) == m_pProps);
  }
...
VistaUserPlatform::VistaUserPlatform(VistaSceneGraph* pSG, VistaDisplaySystem* pDispSys)
    : m_pPlatTrans(new VistaVirtualPlatformAdapter)
    , m_pPlatformNode(NULL)
    , m_pUserNode(NULL)
    , m_pSG(pSG)
