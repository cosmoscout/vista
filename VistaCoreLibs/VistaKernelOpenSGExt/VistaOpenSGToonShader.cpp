...
{
	if( SetUniformParameter( VistaOpenSGPerMaterialShader::CShaderUniformParam(
										"iNumBins", iBins ) ) )
	{
		m_iNumBins = iBins;
		return true;
...
bool VistaOpenSGToonShader::ApplyToOSGMaterial( osg::ChunkMaterialPtr& pOSGMaterial )
{
	...
	osg::TextureChunkPtr pOSGTexChunk( osg::TextureChunkPtr::dcast(	pOSGMaterial->find( osg::TextureChunk::getClassType(), 0 ) ) );
