...
public:	
	...
	bool SetObjectEnvironmentMap( const std::string& sTopImage,
	...
	bool SetWorldEnvironmentMap( const std::string& sTopImage,
					const std::string& sBottomImage,
					const std::string& sLeftImage,
					const std::string& sRightImage,
					const std::string& sFrontImage,
	...
	bool SetBumpMap( const std::string& sImageFile,
					const float nDepthMagnitude,
					const bool bSaveNormalMap = true );
