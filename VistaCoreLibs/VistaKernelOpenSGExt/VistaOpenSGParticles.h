...
public:
	...
	void SetUseUnscaledGaussBlobTexture(const int iTexSize, const float fSigma, const float fCenterHeight) const;
	...
	*/ 
	void SetShaderPrograms(const std::string &VertexShaderProgram, const std::string &FragmentShaderProgram);
	void RemoveShader();
