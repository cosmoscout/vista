...
class VISTAKERNELOPENSGEXTAPI PMPhysicalEnvironment {
 public:
  PMPhysicalEnvironment(float fObjectMass, float fObjectVolume, float fObjectDenisty,
      float fGravity, float fDensity, const VistaVector3D& v3LiftCoefficient,
      const VistaVector3D& v3DragCoefficientXYZ, const VistaVector3D& v3WorkingSurfaceXYZ);

  PMPhysicalEnvironment(float fObjectMass, float fGravity, float fDensity,
      const VistaVector3D& v3DragCoefficientXYZ, const VistaVector3D& v3WorkingSurfaceXYZ);
  virtual ~PMPhysicalEnvironment();

  // Applies Physics to the object calling this function! Currently only used for particles, but
  // other objects might profit, too!
  VistaVector3D ApplyPhysics(float* v3VelocitiesVector, float* v3PositionVector,
...
class VISTAKERNELOPENSGEXTAPI PMPhysicalFrameChange
    : public VistaOpenSGParticleManager::IParticleChanger {
 public:
...
class VISTAKERNELOPENSGEXTAPI PMOriginSet : public VistaOpenSGParticleManager::IParticleChanger {
 public:
  PMOriginSet(const VistaVector3D& v3ParticleVelocities, float fVelocitiesFactor,
...
// given factor.
class VISTAKERNELOPENSGEXTAPI PMLinearFrameChange
    : public VistaOpenSGParticleManager::IParticleChanger {
 public:
