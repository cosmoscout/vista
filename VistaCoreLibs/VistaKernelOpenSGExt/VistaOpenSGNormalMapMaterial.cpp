...
bool GetEntryFromTexture(const float nTexCoordX, const float nTexCoordY,
    osg::TextureChunkPtr pTexture, VistaColor& oResult) {
  ...
  case osg::Image::OSG_RGBA_PF:
    ...
    break;
  default:
    vstr::warnp() << "VistaOpenSGNormalMapMaterial - unsupported pixel format for color retrieval"
                  << std::endl;
    return false;
  }
  ...
  case osg::Image::OSG_UINT8_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::UInt8>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colBottomRight = GetPixelEntry<osg::UInt8>(
        nPixelUpperX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colTopLeft = GetPixelEntry<osg::UInt8>(
        nPixelLowerX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    colTopRight = GetPixelEntry<osg::UInt8>(
        nPixelUpperX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    break;
  case osg::Image::OSG_UINT16_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::UInt16>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colBottomRight = GetPixelEntry<osg::UInt16>(
        nPixelUpperX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colTopLeft = GetPixelEntry<osg::UInt16>(
        nPixelLowerX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    colTopRight = GetPixelEntry<osg::UInt16>(
        nPixelUpperX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    break;
  case osg::Image::OSG_UINT32_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::UInt32>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colBottomRight = GetPixelEntry<osg::UInt32>(
        nPixelUpperX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colTopLeft = GetPixelEntry<osg::UInt32>(
        nPixelLowerX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    colTopRight = GetPixelEntry<osg::UInt32>(
        nPixelUpperX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    break;
  case osg::Image::OSG_FLOAT16_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::Real16>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colBottomRight = GetPixelEntry<osg::Real16>(
        nPixelUpperX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colTopLeft = GetPixelEntry<osg::Real16>(
        nPixelLowerX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    colTopRight = GetPixelEntry<osg::Real16>(
        nPixelUpperX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData);
    break;
  case osg::Image::OSG_FLOAT32_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::Real32>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData, false);
    colBottomRight = GetPixelEntry<osg::Real32>(
        nPixelUpperX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData, false);
    colTopLeft = GetPixelEntry<osg::Real32>(
        nPixelLowerX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData, false);
    colTopRight = GetPixelEntry<osg::Real32>(
        nPixelUpperX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData, false);
    break;
  case osg::Image::OSG_INT16_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::Int16>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData, false);
    colBottomRight = GetPixelEntry<osg::Int16>(
        nPixelUpperX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData, false);
    colTopLeft = GetPixelEntry<osg::Int16>(
        nPixelLowerX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData, false);
    colTopRight = GetPixelEntry<osg::Int16>(
        nPixelUpperX, nPixelUpperY, nSizeX, nSizeY, nNumComponents, pData, false);
    break;
  case osg::Image::OSG_INT32_IMAGEDATA:
    colBottomLeft = GetPixelEntry<osg::Int32>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colBottomRight = GetPixelEntry<osg::Int32>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colTopLeft = GetPixelEntry<osg::Int32>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    colTopRight = GetPixelEntry<osg::Int32>(
        nPixelLowerX, nPixelLowerY, nSizeX, nSizeY, nNumComponents, pData);
    break;
  default:
 ...
 public:
  ...
  void setBaseMap(ImagePtr img) {
    ...
    if (img == NullFC) {
      ...
      beginEditCP(shl, SHLChunk::FragmentProgramFieldMask | SHLChunk::ParametersFieldMask);
      shl->setFragmentProgram(_fs_normalmap);
      shl->subUniformParameter("baseMap");
      endEditCP(shl, SHLChunk::FragmentProgramFieldMask | SHLChunk::ParametersFieldMask);
      updateUniforms();
      return;
    }
...
void VistaOpenSGNormalMapMaterial::ApplyToGeometry(VistaGeometry* pGeo, bool generateTangents) {
  ...
  if (generateTangents) {
    ...
    if (gop.traverse(nd)) {
      ...
      vstr::errp() << "[VistaOpenSGNormalMapMaterial] - invalid geometry detected, cannot generate "
  ...
  ChunkMaterialRefPtr ptrOldMat(ChunkMaterialPtr::dcast(ptrGeo->getMaterial()));
...
bool VistaOpenSGNormalMapMaterial::SetNormalMap(
    const char* pFileName, bool convertFromBumpMap) const {
  // read image
...
void VistaOpenSGNormalMapMaterial::SetLightPosition(
...
void VistaOpenSGNormalMapMaterial::SetVistaLight(VistaLightNode* pObj) {
  if (m_pEvMgr == NULL) {
    vstr::warnp() << "[VistaOpenSGNormalMapMaterial]: trying to register light node, but no event "
                     "manager registered"
                  << std::endl;
    return;
  }
...
bool VistaOpenSGNormalMapMaterial::GetBaseMapEntry(
    const float nTexCoordX, const float nTexCoordY, VistaColor& oResult) {
  return GetEntryFromTexture(nTexCoordX, nTexCoordY, m_pData->bmap, oResult);
}

bool VistaOpenSGNormalMapMaterial::GetNormalMapEntry(
    const float nTexCoordX, const float nTexCoordY, VistaColor& oResult) {
