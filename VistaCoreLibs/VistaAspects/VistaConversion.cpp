...
const PrefixDesc s_aSIPrefixesPositive[] = {PrefixDesc("kilo", "k"), PrefixDesc("mega", "M"),
    PrefixDesc("giga", "G"), PrefixDesc("tera", "T"), PrefixDesc("peta", "P"),
    PrefixDesc("exa", "E"), PrefixDesc("zetta", "Z"), PrefixDesc("yotta", "Y")};
const PrefixDesc s_aSIPrefixesNegative[] = {PrefixDesc("milli", "m"), PrefixDesc("micro", "u"),
    PrefixDesc("nano", "n"), PrefixDesc("pico", "p"), PrefixDesc("femto", "f"),
    PrefixDesc("atto", "a"), PrefixDesc("zepto", "z"), PrefixDesc("yocto", "y")};
const int        s_nNumSIPrefixes        = 8;

const PrefixDesc s_aBinaryPrefixes[]  = {PrefixDesc("kibi", "Ki"), PrefixDesc("mebi", "Mi"),
    PrefixDesc("gibi", "Gi"), PrefixDesc("tebi", "Ti"), PrefixDesc("pebi", "Pi"),
    PrefixDesc("exbi", "Ei"), PrefixDesc("zebi", "Zi"), PrefixDesc("yobi", "Yi")};
...
std::string VistaConversion::StringToUpper(const std::string& oSource) {
  ...
  for (std::string::const_iterator itChar = oSource.begin(); itChar != oSource.end();
       ++itChar, ++itTarget) {
...
bool VistaConversion::CheckRemainingStringEmpty(
