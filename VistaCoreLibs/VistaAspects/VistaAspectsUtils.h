...
class VISTAASPECTSAPI VistaAspectsConversionStuff {
 public:
  ...
  static unsigned int ConvertToList(
      const std::string& sValue, std::list<double>& liStrings, char cSep = ',');
  static unsigned int ConvertToList(
      const std::string& sValue, std::list<float>& liStrings, char cSep = ',');
  static unsigned int ConvertToList(
      const std::string& sValue, std::list<int>& liStrings, char cSep = ',');
  static unsigned int ConvertToList(
      const std::string& sValue, std::list<bool>& liStrings, char cSep = ',');
  static unsigned int ConvertToList(const std::string& sValue, std::list<std::string>& liStrings,
      char cSep = ',', bool bTrim = true);
  ...
  static int ConvertToList(
      const unsigned int* pArray, int iCount, std::list<unsigned int>& liOutput);
  ...
  static bool ConvertStringTo4Float(
  ...
  static bool ConvertStringTo4Double(
...
class VISTAASPECTSAPI VistaAspectsComparisonStuff {
 public:
  ...
  static bool StringCaseInsensitiveEquals(const std::string& sString1, const std::string& sString2);
  static bool StringLess(const std::string& sString1, const std::string& sString2);
  static bool StringCaseInsensitiveLess(const std::string& sString1, const std::string& sString2);
