...
#define REFL_IMPLEMENT_FULL(classname, superclass)                                                 \
  namespace {                                                                                      \
  std::string SsReflectionName(#classname);                                                        \
  }                                                                                                \
  std::string classname::GetReflectionableType() const {                                           \
    return #classname;                                                                             \
  }                                                                                                \
...
template <class T>
bool compAssignAndNotify(const T x, T& y, IVistaReflectionable& oObj, int nMsg) {
  if (x != y) {
    y = x;
    oObj.Notify(nMsg);
    return true;
...
class TVistaPropertyGet : public IVistaPropertyGetFunctor {
 public:
   ...
   */
  TVistaPropertyGet(const std::string& sPropName, const std::string& sClassType, GetterFn pfGetter,
      const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfGetter(pfGetter) {
  }

  virtual bool operator()(const IVistaPropertyAwareable& rObj, VistaProperty& rProp) const {
 ...
 *
 */
template <class R, class ConvArg, class C,
    VistaProperty::ePropType nPropType = VistaProperty::PROPT_STRING>
class TVistaPropertyConvertAndGet : public IVistaPropertyGetFunctor {
 public:
   ...
   * @param	sDescription Descriptive string
   */
  TVistaPropertyConvertAndGet(const std::string& sPropName, const std::string& sClassType,
      GetterFn pfGetter, ConvertFn pfConvert, const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfGetter(pfGetter)
...
class TVistaPropertySet : public IVistaPropertySetFunctor {
 ...
 public:
   ...
   */
  TVistaPropertySet(const std::string& sPropName, const std::string& sClassType,
      SetterFunc pfSetter, const std::string& sDescription = "")
...
class TVistaPropertyConvertAndSet : public IVistaPropertySetFunctor {
 ...
 public:
   ...
   */
  TVistaPropertyConvertAndSet(const std::string& sPropName, const std::string& sClassType,
      SetterFunc pfSetter, ConvertFunc pfConvert, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(sPropName, sClassType, sDescription)
      , m_pfSetter(pfSetter)
      , m_pfConvert(pfConvert) {
  }
...
class TVistaPropertyListGet : public IVistaPropertyGetFunctor {
 ...
 public:
  TVistaPropertyListGet(const std::string& sPropName, const std::string& sClassName,
      GetterFn pfGetter, const std::string& sDescription = "")
...
template <class C>
class TVistaPropertyListSet : public IVistaPropertySetFunctor {
 public:
  typedef bool (C::*SetterFunc)(const VistaPropertyList&);

  TVistaPropertyListSet(const std::string& sName, const std::string& sClassName,
      SetterFunc pfSetter, const std::string& sDescription = "")
...
class TVistaPublicVariablePropertyGet : public IVistaPropertyGetFunctor {
 public:
  ...
  TVistaPublicVariablePropertyGet(const std::string& sPropName, const std::string& sClassType,
      MemberVariable pfMember, const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfMember(pfMember) {
  }
  ...
  virtual bool operator()(const IVistaPropertyAwareable& rObj, VistaProperty& rProp) const {
    std::string sValue;
    VistaConversion::ToString<VariableType>(
        static_cast<const ClassType&>(rObj).*m_pfMember, sValue);
...
template <class ClassType, class VariableType, class ConvertArg,
    VistaProperty::ePropType nPropType = VistaProperty::PROPT_STRING>
class TVistaPublicVariablePropertyConvertAndGet : public IVistaPropertyGetFunctor {
 public:
  ...
  TVistaPublicVariablePropertyConvertAndGet(const std::string& sPropName,
      const std::string& sClassType, MemberVariable pfMember, ConvertFunc pfConvert,
      const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfMember(pfMember)
      , m_pfConvert(pfConvert) {
...
class TVistaPublicVariablePropertySet : public IVistaPropertySetFunctor {
 public:
  ...
  TVistaPublicVariablePropertySet(const std::string& sPropName, const std::string& sClassType,
      MemberVariable pfMember, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(sPropName, sClassType, sDescription)
      , m_pfMember(pfMember) {
  }
  ...
  virtual bool operator()(IVistaPropertyAwareable& rObj, const VistaProperty& rProp) {
    return VistaConversion::FromString<VariableType>(
        rProp.GetValue(), static_cast<ClassType&>(rObj).*m_pfMember);
  }
...
template <class C>
class TVistaPublicStringPropertyGet : public IVistaPropertyGetFunctor {
 public:
  typedef std::string(C::*StringMember);
  TVistaPublicStringPropertyGet(const std::string& sPropName, const std::string& sClassType,
      StringMember pfMember, const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfMember(pfMember) {
  }
...
template <class C>
class TVistaPublicStringPropertySet : public IVistaPropertySetFunctor {
 public:
  typedef std::string(C::*StringMember);
  /**
   * This constructor takes all the necessary parameters for creating a
   ...
   */
  TVistaPublicStringPropertySet(const std::string& sPropName, const std::string& sClassType,
      StringMember pfMember, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(sPropName, sClassType, sDescription)
      , m_pfMember(pfMember) {
  }
...
class TVistaProperty2RefGet : public IVistaPropertyGetFunctor {
 public:
   ...
   * @param	pfGetter	pointer to the reflectionable's get method to be used
   */
  TVistaProperty2RefGet(const std::string& sPropName, const std::string& sClassType,
      GetterFunc pfGetter, const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfGetter(pfGetter) {
  }
...
class TVistaProperty2ValSet : public IVistaPropertySetFunctor {
 public:
   ...
   * @param	pfSetter	pointer to the reflectionable's set method to be used
   */
  TVistaProperty2ValSet(const std::string& sPropName, const std::string& sClassType,
      SetterFunc pfSetter, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(sPropName, sClassType, sDescription)
      , m_pfSetter(pfSetter) {
  }
...
class TVistaProperty3RefGet : public IVistaPropertyGetFunctor {
 public:
   ...
   * @param	pfGetter	pointer to the reflectionable's get method to be used
   */
  TVistaProperty3RefGet(const std::string& sPropName, const std::string& sClassType,
      GetterFunc pfGetter, const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfGetter(pfGetter) {
  }
  ...
  virtual bool operator()(const IVistaPropertyAwareable& rObj, VistaProperty& rProp) const {
    A aArray[3];
    if ((static_cast<const C&>(rObj).*m_pfGetter)(aArray[0], aArray[1], aArray[2]) == false) {
      return false;
    }
...
class TVistaProperty3ValSet : public IVistaPropertySetFunctor {
 public:
   ...
   * @param	pfSetter	pointer to the reflectionable's set method to be used
   */
  TVistaProperty3ValSet(const std::string& sPropName, const std::string& sClassType,
      SetterFunc pfSetter, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(sPropName, sClassType, sDescription)
      , m_pfSetter(pfSetter) {
  }
  ...
  virtual bool operator()(IVistaPropertyAwareable& rObj, const VistaProperty& rProp) {
    ...
    if (VistaConversion::ArrayFromString<3, Arg>(rProp.GetValue(), aData)) {
      return (static_cast<C&>(rObj).*m_pfSetter)(aData[0], aData[1], aData[2]);
    }
    return false;
  }
...
class TVistaProperty4RefGet : public IVistaPropertyGetFunctor {
 public:
   ...
   * @param	pfGetter	pointer to the reflectionable's get method to be used
   */
  TVistaProperty4RefGet(const std::string& sPropName, const std::string& sClassType,
      GetterFunc pfGetter, const std::string& sDescription = "")
      : IVistaPropertyGetFunctor(sPropName, sClassType, sDescription)
      , m_pfGetter(pfGetter) {
  }
  ...
  virtual bool operator()(const IVistaPropertyAwareable& rObj, VistaProperty& rProp) const {
    A aArray[4];
    if ((static_cast<const C&>(rObj).*m_pfGetter)(aArray[0], aArray[1], aArray[2], aArray[3]) ==
        false) {
      return false;
    }
...
class TVistaProperty4ValSet : public IVistaPropertySetFunctor {
 public:
   ...
   * @param	pfSetter	pointer to the reflectionable's set method to be used
   */
  TVistaProperty4ValSet(const std::string& sPropName, const std::string& sClassType,
      SetterFunc pfSetter, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(sPropName, sClassType, sDescription)
      , m_pfSetter(pfSetter) {
  }
  ...
  virtual bool operator()(IVistaPropertyAwareable& rObj, const VistaProperty& rProp) {
    ...
    if (VistaConversion::ArrayFromString<4, Arg>(rProp.GetValue(), aData)) {
      return (static_cast<C&>(rObj).*m_pfSetter)(aData[0], aData[1], aData[2], aData[3]);
    }
    return false;
  }
...
class TVistaPropertyArrayGet : public IVistaPropertyGetFunctor {
 public:
   ...
   */
  TVistaPropertyArrayGet(const std::string& strPropertyName, const std::string& strClassType,
      GetterFunc pfGetter, const std::string& sDescription = "")
...
class TVistaPropertyArraySet : public IVistaPropertySetFunctor {
 public:
   ...
   */
  TVistaPropertyArraySet(const std::string& strPropertyName, const std::string& strClassName,
      SetterFunc pfSetter, const std::string& sDescription = "")
   ...
   */
  TVistaPropertyArraySet(const std::string& strPropertyName, const std::string& strClassName,
      SetterFuncConst pfSetter, const std::string& sDescription = "")
      : IVistaPropertySetFunctor(strPropertyName, strClassName, sDescription)
      , m_pfSetterFunc(NULL)
...
IVistaPropertySetFunctor* CreateVistaPropertySet(const std::string& sPropName,
    const std::string& sClassType, bool (C::*pfSetter)(Arg), const std::string& sDescription = "") {
...
IVistaPropertySetFunctor* CreateVistaPropertyConvertAndSet(const std::string& sPropName,
    const std::string& sClassType, bool (C::*pfSetter)(Arg), CRes (*pfConvert)(const std::string&),
    const std::string& sDescription = "") {
  return new TVistaPropertyConvertAndSet<Arg, CRes, C>(
      sPropName, sClassType, pfSetter, pfConvert, sDescription);
}
...
IVistaPropertyGetFunctor* CreateVistaPropertyGet(const std::string& sPropName,
    const std::string& sClassType, R (C::*pfGetter)() const, const std::string& sDescription = "") {
...
IVistaPropertyGetFunctor* CreateVistaPropertyConvertAndGet(const std::string& sPropName,
    const std::string& sClassType, R (C::*pfGetter)() const, std::string (*pfConvert)(ConvArg),
    const std::string& sDescription = "") {
  return new TVistaPropertyConvertAndGet<R, ConvArg, C, nPropType>(
      sPropName, sClassType, pfGetter, pfConvert, sDescription);
}
