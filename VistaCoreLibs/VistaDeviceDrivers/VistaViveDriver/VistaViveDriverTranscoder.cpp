...
class VistaViveHeadOrientationTranscode : public IVistaMeasureTranscode::QuatGet {
 public:
  VistaViveHeadOrientationTranscode()
      : IVistaMeasureTranscode::QuatGet(
            "ORIENTATION", VistaViveHeadTranscode::GetTypeString(), "Vive head's 3D orientation") {
  }

  virtual VistaQuaternion GetValue(const VistaSensorMeasure* pMeasure) const {
    VistaViveConfig::VISTA_vive_head_type* m =
        (VistaViveConfig::VISTA_vive_head_type*)&(*pMeasure).m_vecMeasures[0];
 ...
 public:
  VistaViveHeadPosTranscode()
      : IVistaMeasureTranscode::V3Get(
            "POSITION", VistaViveHeadTranscode::GetTypeString(), "Vive head's 3D position") {
  }
...
class VistaViveHeadPoseTranscode
 ...
 public:
  VistaViveHeadPoseTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix>(
            "POSE", VistaViveHeadTranscode::GetTypeString(), "Vive head's 3D pose") {
  }
...
class VistaViveStickTranscode : public IVistaMeasureTranscode {
 public:
  ...
  static std::string GetTypeString() {
    return "VistaViveStickTranscode";
  }
...
class VistaViveStickOrientationTranscode : public IVistaMeasureTranscode::QuatGet {
 public:
  VistaViveStickOrientationTranscode()
      : IVistaMeasureTranscode::QuatGet("ORIENTATION", VistaViveStickTranscode::GetTypeString(),
            "Vive stick's 3D orientation") {
  }

  virtual VistaQuaternion GetValue(const VistaSensorMeasure* pMeasure) const {
    VistaViveConfig::VISTA_vive_stick_type* m =
        (VistaViveConfig::VISTA_vive_stick_type*)&(*pMeasure).m_vecMeasures[0];
    // VistaTransformMatrix mt (float(m->rot[0]), float(m->rot[3]), float(m->rot[6]), 0,
    // 	float(m->rot[1]), float(m->rot[4]), float(m->rot[7]), 0,
    // 	float(m->rot[2]), float(m->rot[5]), float(m->rot[8]), 0,
    // 	0    , 0    , 0    , 1);
...
class VistaViveStickPosTranscode : public IVistaMeasureTranscode::V3Get {
 public:
  VistaViveStickPosTranscode()
      : IVistaMeasureTranscode::V3Get(
            "POSITION", VistaViveStickTranscode::GetTypeString(), "Vive stick's 3D position") {
  }
...
class VistaViveStickPoseTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix> {
 public:
  VistaViveStickPoseTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix>(
            "POSE", VistaViveStickTranscode::GetTypeString(), "Vive stick's 3D pose") {
  }
...
class VistaViveStickTriggerPressedTranscode
 ...
 public:
  VistaViveStickTriggerPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("TRIGGER_PRESSED",
            VistaViveStickTranscode::GetTypeString(), "Vive stick's trigger button") {
  }
...
class VistaViveStickTriggerTouchedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
 ...
 public:
  VistaViveStickTriggerXTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<float>("TRIGGER_X",
            VistaViveStickTranscode::GetTypeString(), "vive stick trigger's x pos in comp (-1,1)") {
  }
 ...
 public:
  VistaViveStickGripPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>(
            "GRIP_PRESSED", VistaViveStickTranscode::GetTypeString(), "Vive stick's grip button") {
  }
...
class VistaViveStickTrackpadPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaViveStickTrackpadPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("TRACKPAD_PRESSED",
            VistaViveStickTranscode::GetTypeString(), "Vive stick's button trackpad") {
  }
...
class VistaViveStickTrackpadTouchedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
...
class VistaViveStickTrackpadAxesTranscode : public IVistaMeasureTranscode::V3Get {
 public:
  VistaViveStickTrackpadAxesTranscode()
      : IVistaMeasureTranscode::V3Get("TRACKPADPAD_AXES", VistaViveStickTranscode::GetTypeString(),
...
class VistaViveStickSystemButtonPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaViveStickSystemButtonPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("BUTTON_SYSTEM_PRESSED",
            VistaViveStickTranscode::GetTypeString(), "Vive stick's system button") {
  }
...
class VistaViveStickMenuButtonPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaViveStickMenuButtonPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("BUTTON_MENU_PRESSED",
            VistaViveStickTranscode::GetTypeString(), "Vive stick's menu button") {
  }
...
IVistaPropertyGetFunctor* SapGetter[] = {new VistaViveHeadOrientationTranscode,
    new VistaViveHeadPosTranscode, new VistaViveHeadPoseTranscode,
    new VistaViveStickOrientationTranscode, new VistaViveStickPosTranscode,
    new VistaViveStickPoseTranscode, new VistaViveStickTriggerPressedTranscode,
    new VistaViveStickTriggerTouchedTranscode, new VistaViveStickTriggerXTranscode,
    new VistaViveStickGripPressedTranscode, new VistaViveStickTrackpadPressedTranscode,
    new VistaViveStickTrackpadTouchedTranscode, new VistaViveStickTrackpadAxesTranscode,
    new VistaViveStickTrackpadXTranscode, new VistaViveStickTrackpadYTranscode,
    new VistaViveStickSystemButtonPressedTranscode, new VistaViveStickMenuButtonPressedTranscode,
    NULL};
