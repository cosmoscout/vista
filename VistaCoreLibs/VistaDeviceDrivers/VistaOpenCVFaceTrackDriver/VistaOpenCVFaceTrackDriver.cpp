...
, m_pImage( NULL )
{
	...
	RegisterAspect( new VistaOpenCVFaceTrackEnableAspect( this, &VistaOpenCVFaceTrackDriver::PhysicalEnable ) );
}
...
VistaOpenCVFaceTrackDriver::~VistaOpenCVFaceTrackDriver()
{
	...
	VistaOpenCVFaceTrackEnableAspect *enabler = GetAspectAs< VistaOpenCVFaceTrackEnableAspect >( VistaDriverEnableAspect::GetAspectId() );
