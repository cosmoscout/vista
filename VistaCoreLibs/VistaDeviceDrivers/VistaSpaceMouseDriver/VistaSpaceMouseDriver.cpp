...
VistaSpaceMouseDriver::~VistaSpaceMouseDriver()
{
	...
	VistaDriverEnableAspect *enabler = GetAspectAs<VistaDriverEnableAspect>( VistaDriverEnableAspect::GetAspectId() );
...
bool VistaSpaceMouseDriver::DoSensorUpdate(VistaType::microtime dTs)
{
	...
	VistaSpaceMouseMeasures::sSpaceMouseMeasure *m = pM->getWrite< VistaSpaceMouseMeasures::sSpaceMouseMeasure >();
