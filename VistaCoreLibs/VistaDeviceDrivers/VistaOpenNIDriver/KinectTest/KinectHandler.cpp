...
IVistaPropertySetFunctor* SaSetter[] = {
    new TActionSetFunctor<KinectHandler, std::vector<VistaVector3D>,
        const std::vector<VistaVector3D>&>(&KinectHandler::SetPosition, NULL, "position",
        SsReflectionName, "sets position of objects"),
    new TActionSetFunctor<KinectHandler, VistaTransformMatrix, const VistaTransformMatrix&>(
        &KinectHandler::SetTransformation, NULL, "transform", SsReflectionName,
...
void KinectHandler::CreateElement(
    int nElement, VistaGeometry* pGeom, const VistaVector3D& v3Offset) {
