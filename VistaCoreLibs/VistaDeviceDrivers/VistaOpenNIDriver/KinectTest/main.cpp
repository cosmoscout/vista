...
int main(int argc, char* argv[]) {
  ...
  VistaGeometry*       pGeom =
      oFactory.CreateBox(S_fCubeSize, S_fCubeSize, S_fCubeSize, 1, 1, 1, VistaColor::LIGHT_GRAY);
  ...
  oSystem.GetKeyboardSystemControl()->BindAction(
      'b', new ModeToggle(&oSystem, pGridRoot, &oHandler), "toggle between figure and ucp");
