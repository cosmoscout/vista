...
class VistaPhantomServerDriverMeasureTranscode : public IVistaMeasureTranscode {
 public:
  ...
  static std::string GetTypeString() {
    return "VistaPhantomServerDriverMeasureTranscode";
  }
...
class VistaPhantomServerPosTranscode : public IVistaMeasureTranscode::V3Get {
 public:
  ...
  virtual VistaVector3D GetValue(const VistaSensorMeasure* pMeasure) const {
    const VistaPhantomServerMeasures::sPhantomServerMeasure* m =
        pMeasure->getRead<VistaPhantomServerMeasures::sPhantomServerMeasure>();
 ...
 public:
  VistaPhantomServerForceReadTranscode()
      : IVistaMeasureTranscode::V3Get("FORCE",
            VistaPhantomServerDriverMeasureTranscode::GetTypeString(), "phantom 3D force values") {
  }
 ...
 public:
  VistaPhantomServerScalarTranscode()
      : IVistaMeasureTranscode::ScalarDoubleGet("DSCALAR",
            VistaPhantomServerDriverMeasureTranscode::GetTypeString(), "Phantom scalar values") {
  }
 ...
 public:
  VistaPhantomServerRotationGet()
      : IVistaMeasureTranscode::QuatGet("ORIENTATION",
            VistaPhantomServerDriverMeasureTranscode::GetTypeString(), "phantom body orientation") {
  }
...
static IVistaPropertyGetFunctor* SapGetter[] = {new VistaPhantomServerPosTranscode,
    new VistaPhantomServerForceReadTranscode, new VistaPhantomServerScalarTranscode,
    new VistaPhantomServerPosSCPTranscode, new VistaPhantomServerVelocityTranscode,
    new VistaPhantomServerRotationGet, NULL};
} // namespace
...
class VistaPhantomServerTranscoderFactory
    : public TDefaultTranscoderFactory<VistaPhantomServerDriverMeasureTranscode> {
 public:
  VistaPhantomServerTranscoderFactory()
      : TDefaultTranscoderFactory<VistaPhantomServerDriverMeasureTranscode>(
            VistaPhantomServerDriverMeasureTranscode::GetTypeString()) {
  }
};
