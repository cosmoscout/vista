...
class VistaWiimoteTranscodeFactory : public IVistaMeasureTranscoderFactory {
 public:
  ...
  virtual std::string GetTranscoderName() const {
    return "VistaWiimoteTranscodeFactory";
  }
};
 ...
 public:
  VistaWiimoteIndexedButtonGet()
      : IVistaMeasureTranscode::ScalarDoubleGet(
            "BUTTON", VistaWiimoteTranscoder::GetTypeString(), "retrieve button states (0-11)") {
  }
...
class VistaWiimoteAccelerationGet : public IVistaMeasureTranscode::V3Get {
 public:
  VistaWiimoteAccelerationGet()
      : IVistaMeasureTranscode::V3Get("ACCELERATION", VistaWiimoteTranscoder::GetTypeString(),
...
class VistaWiimotePosGet : public IVistaMeasureTranscode::V3Get {
 public:
  VistaWiimotePosGet()
      : IVistaMeasureTranscode::V3Get("IRPOSITION", VistaWiimoteTranscoder::GetTypeString(),
...
class VistaWiimoteSingleButtonGet : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaWiimoteSingleButtonGet(
      unsigned short nIndex, const std::string& sName, const std::string& strDesc)
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>(
            sName, VistaWiimoteTranscoder::GetTypeString(), strDesc)
      , m_nIndex(nIndex) {
  }
...
class VistaWiimoteIRMarkerGet : public IVistaMeasureTranscode::TTranscodeValueGet<VistaVector3D> {
 public:
  VistaWiimoteIRMarkerGet(
      unsigned short nIndex, const std::string& sName, const std::string& strDesc)
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaVector3D>(
            sName, VistaWiimoteTranscoder::GetTypeString(), strDesc)
      , m_nIndex(nIndex) {
  }
...
class VistaNunchukPaddleGet : public IVistaMeasureTranscode::V3Get {
 public:
  VistaNunchukPaddleGet()
      : IVistaMeasureTranscode::V3Get("PADDLE", VistaNunchukTranscoder::GetTypeString(),
  ...
  virtual bool GetValue(const VistaSensorMeasure* pMeasure, VistaVector3D& v3) const {
    ...
    const nunchuk_t* m = pMeasure->getRead<nunchuk_t>();
    ...
    if (std::fabs(m->js.mag - 0.01f) < std::numeric_limits<float>::epsilon() ||
        myisnan(m->js.ang)) {
...
class VistaNunchukButtonGet : public IVistaMeasureTranscode::ScalarDoubleGet {
 public:
  VistaNunchukButtonGet()
      : IVistaMeasureTranscode::ScalarDoubleGet(
            "BUTTON", VistaNunchukTranscoder::GetTypeString(), "get nunchuk buttons by index") {
  }
...
class VistaNunchukAccelerationGet : public IVistaMeasureTranscode::V3Get {
 public:
  VistaNunchukAccelerationGet()
      : IVistaMeasureTranscode::V3Get("ACCELERATION", VistaNunchukTranscoder::GetTypeString(),
...
class VistaNunchukOrientationGet : public IVistaMeasureTranscode::QuatGet {
 public:
  VistaNunchukOrientationGet()
      : IVistaMeasureTranscode::QuatGet("ORIENTATION", VistaNunchukTranscoder::GetTypeString(),
  ...
  virtual bool GetValue(const VistaSensorMeasure* pMeasure, VistaQuaternion& q) const {
    ...
    mt.SetToRotationMatrix(
        VistaQuaternion(VistaEulerAngles(m->orient.yaw, m->orient.roll, m->orient.pitch)));
...
class VistaNunchukGravityGet : public IVistaMeasureTranscode::V3Get {
 public:
  VistaNunchukGravityGet()
      : IVistaMeasureTranscode::V3Get("GRAVITY", VistaNunchukTranscoder::GetTypeString(),
...
class VistaNunchukSingleButtonGet : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaNunchukSingleButtonGet(int nIndex, const std::string& sName, const std::string& strDesc)
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>(
            sName, VistaNunchukTranscoder::GetTypeString(), strDesc)
      , m_nIndex(nIndex) {
  }
...
class VistaClassicPaddleGet : public IVistaMeasureTranscode::V3Get {
 public:
  ...
  VistaClassicPaddleGet(ePad nIndex, const std::string& strName, const std::string& strDesc)
      : IVistaMeasureTranscode::V3Get(strName, VistaClassicTranscoder::GetTypeString(), strDesc)
      , m_nIndex(nIndex) {
  }
  ...
  virtual bool GetValue(const VistaSensorMeasure* pMeasure, VistaVector3D& v3) const {
    ...
    const classic_ctrl_t* m = pMeasure->getRead<classic_ctrl_t>();
...
class VistaClassicButtonGet : public IVistaMeasureTranscode::ScalarDoubleGet {
 public:
  VistaClassicButtonGet()
      : IVistaMeasureTranscode::ScalarDoubleGet("BUTTON", VistaClassicTranscoder::GetTypeString(),
 ...
 public:
  ...
  VistaClassicShoulderGet(ePad pd, const std::string& strName, const std::string& strDesc)
      : IVistaMeasureTranscode::TTranscodeValueGet<float>(
            strName, VistaClassicTranscoder::GetTypeString(), strDesc)
      , m_ePd(pd) {
  }
...
class VistaGuitarPaddleGet : public IVistaMeasureTranscode::V3Get {
 public:
  VistaGuitarPaddleGet()
      : IVistaMeasureTranscode::V3Get("PADDLE", VistaGuitarTranscoder::GetTypeString(),
  ...
  virtual bool GetValue(const VistaSensorMeasure* pMeasure, VistaVector3D& v3) const {
    if (!pMeasure)
      return false;
    const guitar_hero_3_t* m = pMeasure->getRead<guitar_hero_3_t>();
...
class VistaGuitarButtonGet : public IVistaMeasureTranscode::ScalarDoubleGet {
 public:
  VistaGuitarButtonGet()
      : IVistaMeasureTranscode::ScalarDoubleGet("BUTTON", VistaGuitarTranscoder::GetTypeString(),
 ...
 public:
  VistaGuitarWhammyGet()
      : IVistaMeasureTranscode::TTranscodeValueGet<float>("WHAMMY",
            VistaGuitarTranscoder::GetTypeString(), "retrieve the state of the whammy bar") {
  }
...
IVistaPropertyGetFunctor* SaGetter[] = {new VistaWiimoteIndexedButtonGet,
    new VistaWiimoteAccelerationGet, new VistaWiimotePosGet,
    new VistaWiimoteIRMarkerGet(
        0, "IR_MARKER_0", "position of marker 0 as (x,y,size) [or(0,0,-1) if invisible]"),
    new VistaWiimoteIRMarkerGet(
        1, "IR_MARKER_1", "position of marker 1 as (x,y,size) [or(0,0,-1) if invisible]"),
    new VistaWiimoteIRMarkerGet(
        2, "IR_MARKER_2", "position of marker 2 as (x,y,size) [or(0,0,-1) if invisible]"),
    new VistaWiimoteIRMarkerGet(
        3, "IR_MARKER_3", "position of marker 3 as (x,y,size) [or(0,0,-1) if invisible]"),
    ...
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_MINUS, "BTN_MINUS", "state of button labeled '-'"),
    new VistaWiimoteSingleButtonGet(WIIMOTE_BUTTON_PLUS, "BTN_PLUS", "state of button labeled '+'"),
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_ONE, "BTN_HOME", "state of button labeled 'home'"),
    new VistaWiimoteSingleButtonGet(WIIMOTE_BUTTON_A, "BTN_A", "state of button labeled 'A'"),
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_B, "BTN_B", "state of button labeled 'B' (fire)"),
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_UP, "BTN_UP", "state of button on cross direction up"),
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_LEFT, "BTN_LEFT", "state of button on cross direction left"),
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_RIGHT, "BTN_RIGHT", "state of button on cross direction right"),
    new VistaWiimoteSingleButtonGet(
        WIIMOTE_BUTTON_DOWN, "BTN_DOWN", "state of button on cross direction down"),
    new VistaNunchukPaddleGet, new VistaNunchukAccelerationGet, new VistaNunchukGravityGet,
    new VistaNunchukButtonGet, new VistaNunchukSingleButtonGet(0, "BTN_Z", "retrieve button C"),
    new VistaNunchukSingleButtonGet(1, "BTN_C", "retrieve button Z"),
    new VistaNunchukOrientationGet,
    new VistaClassicPaddleGet(
        VistaClassicPaddleGet::PAD_LEFT, "LPADDLE", "retrieve left paddle as v3"),
    new VistaClassicPaddleGet(
        VistaClassicPaddleGet::PAD_RIGHT, "RPADDLE", "retrieve right paddle as v3"),
    ...
    new VistaStatusBatteryGet, new VistaStatusExpansionStateGet,

    new VistaGuitarPaddleGet, new VistaGuitarButtonGet, new VistaGuitarWhammyGet,
