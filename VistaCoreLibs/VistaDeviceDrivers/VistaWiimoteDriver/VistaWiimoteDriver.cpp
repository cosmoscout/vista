...
: IVistaDriverCreationMethod(metaFac)
{
	RegisterSensorType( "WIIMOTE",
		sizeof(VistaWiimoteDriverCommonShare::MeasureType ),
	...
	RegisterSensorType( "STATUS",
		sizeof(VistaWiimoteDriverCommonShare::_wiistateMeasure ),
...
namespace
{
	...
	IVistaPropertyGetFunctor *SaParameterGetter[] =
	{
		...
		VistaWiimoteDriver::WiiMoteParameters,
		...
		"DOESREPORTIR",
		SsReflectionName,
		&VistaWiimoteDriver::WiiMoteParameters::GetDoesIRReports,
		...
		"WAITTIMEOUT",
		SsReflectionName,
		&VistaWiimoteDriver::WiiMoteParameters::GetWaitTimeout,
		...
		"WIIMOTE_ID",
		SsReflectionName,
		&VistaWiimoteDriver::WiiMoteParameters::GetWiiMoteId,
...
REFL_IMPLEMENT(VistaWiimoteDriver::WiiMoteParameters,
...
bool VistaWiimoteDriver::WiiMoteParameters::SetWiiMoteId( const std::string &strWiiMoteId )
{
	...
	{
		vstr::debug() << "[WiiMoteParameters::SetWiiMoteId]: Already connected, can't set ID anymore" << std::endl;
		return false;
	}
...
bool VistaWiimoteDriver::WiiMoteParameters::SetWaitTimeout( int nTimeoutInSecs )
{
	...
	if( m_pDriver->GetIsConnected() )
	{
		vstr::debug() << "[WiiMoteParameters::SetWiiMoteId]: Already connected, can't set wait timeout anymore" << std::endl;
		return false;
	}
...
{
	VistaWiimoteEnableAspect *enabler = GetAspectAs< VistaWiimoteEnableAspect >( VistaDriverEnableAspect::GetAspectId() );
...
bool VistaWiimoteDriver::DoConnect()
{
	...
	VistaWiimoteDriver::WiiMoteParameters *pParams = dynamic_cast<VistaWiimoteDriver::WiiMoteParameters*>(m_pParams->GetParameterContainer());
...
bool VistaWiimoteDriver::RecordMoteEvent( VistaType::microtime nTs )
{
	...
	VistaWiimoteDriverCommonShare::MeasureType *s = pM->getWrite<VistaWiimoteDriverCommonShare::MeasureType>();
...
bool VistaWiimoteDriver::RecordStateEvent( VistaType::microtime nTs )
{
	...
	VistaWiimoteDriverCommonShare::StateMeasureType *s = pM->getWrite<VistaWiimoteDriverCommonShare::StateMeasureType>();
