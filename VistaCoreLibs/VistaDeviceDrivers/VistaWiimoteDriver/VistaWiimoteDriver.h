...
public:
	...
	class VISTAWIIMOTEDRIVERAPI WiiMoteParameters : public VistaDriverGenericParameterAspect::IParameterContainer
	{
		REFL_DECLARE
	public:
...
class VISTAWIIMOTEDRIVERAPI WiiMoteParameterCreate : public VistaDriverGenericParameterAspect::IContainerCreate
{
public:
