...
namespace
{
	...
	public:
		VRPNAnalogValueGet()
		: IVistaMeasureTranscode::ScalarDoubleGet("VALUE",
	...
	public:
		VRPNButtonValueGet()
		: IVistaMeasureTranscode::UIntGet("STATE",
	...
	public:
		VRPNButtonNumberGet()
		: IVistaMeasureTranscode::UIntGet("NUMBER",
										   VRPNButtonTranscoder::GetTypeString(),
	...
	public:
		VRPNButtonMaskGet()
		: IVistaMeasureTranscode::UIntGet("BTMASK",
										   VRPNButtonTranscoder::GetTypeString(),
	...
	public:
		VRPNSensorNumberGet()
		: IVistaMeasureTranscode::UIntGet("SENSORINDEX",
