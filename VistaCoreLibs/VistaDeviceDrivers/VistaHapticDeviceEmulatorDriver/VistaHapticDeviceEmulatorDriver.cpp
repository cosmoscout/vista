...
typedef TVistaDriverEnableAspect< VistaHapticDeviceEmulatorDriver > VistaHapticDeviceEmulatorEnableAspect;
  ...
  m_maxForce(0.0f), m_maxStiffness(0.0f)
{
	...
	RegisterAspect( new VistaHapticDeviceEmulatorEnableAspect( this, &VistaHapticDeviceEmulatorDriver::PhysicalEnable ) );
...
VistaHapticDeviceEmulatorDriver::~VistaHapticDeviceEmulatorDriver()
{
	...
	VistaHapticDeviceEmulatorEnableAspect *enabler = GetAspectAs< VistaHapticDeviceEmulatorEnableAspect >( VistaDriverEnableAspect::GetAspectId() );
