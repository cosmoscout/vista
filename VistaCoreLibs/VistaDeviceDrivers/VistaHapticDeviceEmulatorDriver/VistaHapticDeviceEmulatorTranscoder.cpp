...
namespace
{
	...
	public:
		...
		{
			const VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure *m = pMeasure->getRead< VistaHapticDeviceEmulatorMeasures::sHapticDeviceEmulatorMeasure >();
