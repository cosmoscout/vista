...
/*============================================================================*/
VistaGlutJoystickDriverCreationMethod::VistaGlutJoystickDriverCreationMethod(
    IVistaTranscoderFactoryFactory* fac)
    : IVistaDriverCreationMethod(fac) {
  RegisterSensorType(
      "", sizeof(VistaGlutJoystickDriver::_sJoyMeasure), 100, fac->CreateFactoryForType(""));
}
...
bool VistaGlutJoystickDriver::_sJoySample::operator==(const _sJoySample& oOther) const {
  return ((oOther.m_nBtMask == m_nBtMask) && (oOther.m_nAxis1 == m_nAxis1) &&
          (oOther.m_nAxis2 == m_nAxis2) && (oOther.m_nAxis3 == m_nAxis3));
}

VistaGlutJoystickDriver::_sJoySample& VistaGlutJoystickDriver::_sJoySample::operator=(
    const _sJoySample& oOther) {
...
bool VistaGlutJoystickDriver::DoSensorUpdate(VistaType::microtime dTs) {
  for (std::vector<_sJoySample>::const_iterator cit = m_vecJoyVec.begin(); cit != m_vecJoyVec.end();
       ++cit) {
