...
typedef TVistaDriverEnableAspect< VistaCHAI3DHapticDevicesDriver > VistaCHAI3DHapticDeviceEnableAspect;
  ...
  m_pUpdateLoop(NULL)
{
	...
	RegisterAspect( new VistaCHAI3DHapticDeviceEnableAspect( this, &VistaCHAI3DHapticDevicesDriver::PhysicalEnable ) );
...
VistaCHAI3DHapticDevicesDriver::~VistaCHAI3DHapticDevicesDriver()
{
	...
	VistaCHAI3DHapticDeviceEnableAspect *enabler = GetAspectAs<VistaCHAI3DHapticDeviceEnableAspect>( VistaDriverEnableAspect::GetAspectId() );
