...
class VistaOpenVRHeadTranscode : public IVistaMeasureTranscode {
 public:
  ...
  static std::string GetTypeString() {
    return "VistaOpenVRHeadTranscode";
  }
...
class VistaOpenVRHeadOrientationTranscode : public IVistaMeasureTranscode::QuatGet {
 public:
  VistaOpenVRHeadOrientationTranscode()
      : IVistaMeasureTranscode::QuatGet("ORIENTATION", VistaOpenVRHeadTranscode::GetTypeString(),
  ...
  virtual VistaQuaternion GetValue(const VistaSensorMeasure* pMeasure) const {
    VistaOpenVRConfig::VISTA_openvr_head_type* m =
        (VistaOpenVRConfig::VISTA_openvr_head_type*)&(*pMeasure).m_vecMeasures[0];
 ...
 public:
  VistaOpenVRHeadPosTranscode()
      : IVistaMeasureTranscode::V3Get(
            "POSITION", VistaOpenVRHeadTranscode::GetTypeString(), "OpenVR head's 3D position") {
  }
...
class VistaOpenVRHeadPoseTranscode
 ...
 public:
  VistaOpenVRHeadPoseTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix>(
            "POSE", VistaOpenVRHeadTranscode::GetTypeString(), "OpenVR head's 3D pose") {
  }
...
class VistaOpenVRStickTranscode : public IVistaMeasureTranscode {
 public:
  ...
  static std::string GetTypeString() {
    return "VistaOpenVRStickTranscode";
  }
...
class VistaOpenVRStickOrientationTranscode : public IVistaMeasureTranscode::QuatGet {
 public:
  VistaOpenVRStickOrientationTranscode()
      : IVistaMeasureTranscode::QuatGet("ORIENTATION", VistaOpenVRStickTranscode::GetTypeString(),
            "OpenVR stick's 3D orientation") {
  }

  virtual VistaQuaternion GetValue(const VistaSensorMeasure* pMeasure) const {
    VistaOpenVRConfig::VISTA_openvr_stick_type* m =
        (VistaOpenVRConfig::VISTA_openvr_stick_type*)&(*pMeasure).m_vecMeasures[0];
    // VistaTransformMatrix mt (float(m->rot[0]), float(m->rot[3]), float(m->rot[6]), 0,
    // 	float(m->rot[1]), float(m->rot[4]), float(m->rot[7]), 0,
    // 	float(m->rot[2]), float(m->rot[5]), float(m->rot[8]), 0,
    // 	0    , 0    , 0    , 1);
...
class VistaOpenVRStickPosTranscode : public IVistaMeasureTranscode::V3Get {
 public:
  VistaOpenVRStickPosTranscode()
      : IVistaMeasureTranscode::V3Get(
            "POSITION", VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's 3D position") {
  }
...
class VistaOpenVRStickPoseTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix> {
 public:
  VistaOpenVRStickPoseTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix>(
            "POSE", VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's 3D pose") {
  }
...
class VistaOpenVRStickTriggerPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaOpenVRStickTriggerPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("TRIGGER_PRESSED",
            VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's trigger button") {
  }
...
class VistaOpenVRStickTriggerTouchedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
...
class VistaOpenVRStickGripPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaOpenVRStickGripPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("GRIP_PRESSED",
            VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's grip button") {
  }
...
class VistaOpenVRStickTrackpadPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaOpenVRStickTrackpadPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("TRACKPAD_PRESSED",
            VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's button trackpad") {
  }
...
class VistaOpenVRStickTrackpadTouchedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
...
class VistaOpenVRStickTrackpadXTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<float> {
 public:
...
class VistaOpenVRStickTrackpadYTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<float> {
 public:
...
class VistaOpenVRStickSystemButtonPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaOpenVRStickSystemButtonPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("BUTTON_SYSTEM_PRESSED",
            VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's system button") {
  }
...
class VistaOpenVRStickMenuButtonPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaOpenVRStickMenuButtonPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("BUTTON_MENU_PRESSED",
            VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's menu button") {
  }
...
class VistaOpenVRStickButtonAPressedTranscode
    : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  VistaOpenVRStickButtonAPressedTranscode()
      : IVistaMeasureTranscode::TTranscodeValueGet<bool>("BUTTON_A_PRESSED",
            VistaOpenVRStickTranscode::GetTypeString(), "OpenVR stick's A button") {
  }
...
IVistaPropertyGetFunctor* SapGetter[] = {new VistaOpenVRHeadOrientationTranscode,
    new VistaOpenVRHeadPosTranscode, new VistaOpenVRHeadPoseTranscode,
    new VistaOpenVRStickOrientationTranscode, new VistaOpenVRStickPosTranscode,
    new VistaOpenVRStickPoseTranscode, new VistaOpenVRStickTriggerPressedTranscode,
    new VistaOpenVRStickTriggerTouchedTranscode, new VistaOpenVRStickTriggerXTranscode,
    new VistaOpenVRStickGripPressedTranscode, new VistaOpenVRStickTrackpadPressedTranscode,
    new VistaOpenVRStickTrackpadTouchedTranscode, new VistaOpenVRStickTrackpadAxesTranscode,
    new VistaOpenVRStickTrackpadXTranscode, new VistaOpenVRStickTrackpadYTranscode,
    new VistaOpenVRStickSystemButtonPressedTranscode,
    new VistaOpenVRStickMenuButtonPressedTranscode, new VistaOpenVRStickButtonAPressedTranscode,
    NULL};
