...
class VistaPhantomDriverMeasureTranscode : public IVistaMeasureTranscode {
 public:
  ...
  static std::string GetTypeString() {
    return "VistaPhantomDriverMeasureTranscode";
  }
 ...
 public:
  VistaPhantomPosTranscode()
      : IVistaMeasureTranscode::V3Get("POSITION",
            VistaPhantomDriverMeasureTranscode::GetTypeString(), "phantom 3D position values") {
  }
...
class VistaPhantomForceReadTranscode : public IVistaMeasureTranscode::V3Get {
 public:
  VistaPhantomForceReadTranscode()
      : IVistaMeasureTranscode::V3Get("FORCE", VistaPhantomDriverMeasureTranscode::GetTypeString(),
 ...
 public:
  VistaPhantomScalarTranscode()
      : IVistaMeasureTranscode::ScalarDoubleGet("DSCALAR",
            VistaPhantomDriverMeasureTranscode::GetTypeString(), "Phantom scalar values") {
  }
 ...
 public:
  VistaPhantomRotationGet()
      : IVistaMeasureTranscode::QuatGet("ORIENTATION",
            VistaPhantomDriverMeasureTranscode::GetTypeString(), "phantom body orientation") {
  }
...
class VistaPhantomVecFieldGet : public IVistaMeasureTranscode::V3Get {
 public:
  ...
  VistaPhantomVecFieldGet(eField eFld, const std::string& strName, const std::string& strDesc)
      : IVistaMeasureTranscode::V3Get(
            strName, VistaPhantomDriverMeasureTranscode::GetTypeString(), strDesc)
      , m_eFld(eFld) {
  }
...
template <class T>
class VistaPhantomVectorFloatGet
 ...
 public:
  ...
  VistaPhantomVectorFloatGet(eField eFld, const std::string& strName, const std::string& strDesc)
...
class VistaPhantomBtGet : public IVistaMeasureTranscode::TTranscodeValueGet<bool> {
 public:
  ...
  VistaPhantomBtGet(eField eFld, const std::string& strName, const std::string& strDesc)
...
class VistaPhantomTransformationGet
 ...
 public:
  VistaPhantomButtonMaskGet()
      : IVistaMeasureTranscode::TTranscodeValueGet<int>("BUTTONMASK",
            VistaPhantomDriverMeasureTranscode::GetTypeString(), "the buttonmask as an int") {
  }
...
static IVistaPropertyGetFunctor* SapGetter[] = {new VistaPhantomPosTranscode,
    new VistaPhantomForceReadTranscode, new VistaPhantomScalarTranscode,
    new VistaPhantomVelocityTranscode, new VistaPhantomRotationGet,
    ...
    new VistaPhantomVecFieldGet(
        VistaPhantomVecFieldGet::FLD_TORQUE, "TORQUE", "the torque as reported by the phantom"),
    ...
    new VistaPhantomBtGet(
        VistaPhantomBtGet::FLD_INKSWITCH, "INKWELLSWITCH", "state of the inkwell switch"),
    new VistaPhantomButtonMaskGet, NULL};
} // namespace
...
class VistaPhantomTranscoderFactory
    : public TDefaultTranscoderFactory<VistaPhantomDriverMeasureTranscode> {
 public:
  VistaPhantomTranscoderFactory()
      : TDefaultTranscoderFactory<VistaPhantomDriverMeasureTranscode>(
            VistaPhantomDriverMeasureTranscode::GetTypeString()) {
  }
};
