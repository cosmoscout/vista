...
VistaGlutKeyboardDriverCreationMethod::VistaGlutKeyboardDriverCreationMethod(
...
void VistaGlutKeyboardDriver::SetKeyValue(
    VistaGlutKeyboardDriver* pKeyboard, unsigned char nKeyValue, bool bIsUp, int nModifier) {
...
void VistaGlutKeyboardDriver::SetSpecialKeyValue(
