...
VistaOptitrackCreationMethod::VistaOptitrackCreationMethod(
    IVistaTranscoderFactoryFactory* pMetaFactory)
    : IVistaDriverCreationMethod(pMetaFactory) {
  RegisterSensorType("RIGID_BODY", sizeof(VistaOptitrackMeasures::RigidBodyMeasure), 240,
      pMetaFactory->CreateFactoryForType("RIGID_BODY"));
}
...
REFL_IMPLEMENT_FULL(
    VistaOptitrackDriver::Parameters, VistaDriverGenericParameterAspect::IParameterContainer);

namespace {

IVistaPropertyGetFunctor* s_aParameterGetter[] = {
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, bool,
        VistaProperty::PROPT_BOOL>("REPORT_MESSAGES", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_bReportMessages,
        "If true, messages from the server will be printed to the console"),
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, bool,
        VistaProperty::PROPT_BOOL>("SERVER_USES_MULTICAST", SsReflectionName,
    ...
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, std::string,
        VistaProperty::PROPT_STRING>("MULTICAST_ADDRESS", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_sMulticastAddress,
        "Multicast address used by the server"),
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, std::string,
        VistaProperty::PROPT_STRING>("SERVER_HOSTNAME", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_sServerHostName, "host name of the optitrack server"),
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, std::string,
        VistaProperty::PROPT_STRING>("OWN_HOSTNAME", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_sOwnHostName, "own host nameP"),
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, int,
        VistaProperty::PROPT_INT>("SERVER_COMMAND_PORT", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_nServerCommandPort,
        "command port of the optitrack server (uses default if <= 0)"),
    new TVistaPublicVariablePropertyGet<VistaOptitrackDriver::Parameters, int,
        VistaProperty::PROPT_INT>("SERVER_DATA_PORT", SsReflectionName,
...
IVistaPropertySetFunctor* s_aParameterSetter[] = {
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, bool>("REPORT_MESSAGES",
        SsReflectionName, &VistaOptitrackDriver::Parameters::m_bReportMessages,
        "If true, messages from the server will be printed to the console"),
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, bool>(
        "SERVER_USES_MULTICAST", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_bServerUsesMulticast,
        "indicates wether the server distributes data using multicast or unicast UDP"),
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, std::string>(
        "MULTICAST_ADDRESS", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_sMulticastAddress,
        "Multicast address used by the server"),
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, std::string>(
        "SERVER_HOSTNAME", SsReflectionName, &VistaOptitrackDriver::Parameters::m_sServerHostName,
        "host name of the optitrack server"),
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, std::string>(
        "OWN_HOSTNAME", SsReflectionName, &VistaOptitrackDriver::Parameters::m_sOwnHostName,
        "own host nameP"),
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, int>(
        "SERVER_COMMAND_PORT", SsReflectionName,
        &VistaOptitrackDriver::Parameters::m_nServerCommandPort,
        "command port of the optitrack server (uses default if <= 0)"),
    new TVistaPublicVariablePropertySet<VistaOptitrackDriver::Parameters, int>("SERVER_DATA_PORT",
        SsReflectionName, &VistaOptitrackDriver::Parameters::m_nServerDataPort,
        "data port of the optitrack server (uses default if <= 0)"),
...
VistaOptitrackDriver::VistaOptitrackDriver(IVistaDriverCreationMethod* pCreationMethod)
  ...
  m_pParamAspect = new VistaDriverGenericParameterAspect(
      new TParameterCreate<VistaOptitrackDriver, Parameters>(this));
...
bool VistaOptitrackDriver::DoSensorUpdate(VistaType::microtime dTimestamp) {
  ...
  for (int nRigidBody = 0; nRigidBody < m_pCurrentFrameData->nRigidBodies; ++nRigidBody) {
    ...
    unsigned int    nRigidBodySensorIndex =
        m_pSensors->GetSensorId(nRigidBodySensorType, oRigidBody.ID);
    if (nRigidBodySensorIndex != VistaDriverSensorMappingAspect::INVALID_TYPE) {
      ...
      VistaOptitrackMeasures::RigidBodyMeasure* pData =
          pMeasure->getWrite<VistaOptitrackMeasures::RigidBodyMeasure>();
      ...
      pData->m_qOrientation =
          VistaQuaternion(oRigidBody.qx, oRigidBody.qy, oRigidBody.qz, oRigidBody.qw);
