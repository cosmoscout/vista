...
class LeapMotionHandTranscoder : public IVistaMeasureTranscode {
 ...
 public:
  ...
  static std::string GetTypeString() {
    return "LeapMotionHandTranscoder";
  }
};
class LeapMotionFingersTranscoder : public IVistaMeasureTranscode {
 ...
 public:
  ...
  static std::string GetTypeString() {
    return "LeapMotionFingersTranscoder";
  }
};
class LeapMotionToolsTranscoder : public IVistaMeasureTranscode {
 ...
 public:
  ...
  static std::string GetTypeString() {
    return "LeapMotionToolsTranscoder";
  }
};
class LeapMotionGestureTranscoder : public IVistaMeasureTranscode {
 ...
 public:
  ...
  static std::string GetTypeString() {
    return "LeapMotionGestureTranscoder";
  }
};
class LeapMotionImageTranscoder : public IVistaMeasureTranscode {
 ...
 public:
  ...
  static std::string GetTypeString() {
    return "LeapMotionImageTranscoder";
  }
};

class LeapMotionHandOrientationGet
    : public IVistaMeasureTranscode::TTranscodeValueGet<VistaQuaternion> {
 public:
  LeapMotionHandOrientationGet()
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaQuaternion>(
            "ORIENTATION", "LeapMotionHandTranscoder", "orientation of the palm") {
  }
  ...
  bool GetValue(const VistaSensorMeasure* pMeasure, VistaQuaternion& oValue) const {
    ...
    const VistaLeapMotionMeasures::HandMeasure* pRealMeasure =
        pMeasure->getRead<VistaLeapMotionMeasures::HandMeasure>();
    VistaTransformMatrix matTransform(
        -pRealMeasure->m_v3PalmDirection.Cross(pRealMeasure->m_v3PalmNormal),
        -pRealMeasure->m_v3PalmNormal, -pRealMeasure->m_v3PalmDirection);
    oValue = matTransform.GetRotationAsQuaternion();
    return true;
  }
};
class LeapMotionHandTransformGet
 ...
 public:
  LeapMotionHandTransformGet()
      : IVistaMeasureTranscode::TTranscodeValueGet<VistaTransformMatrix>(
            "TRANSFORM", "LeapMotionHandTranscoder", "transformation of the palm") {
  }
  ...
  bool GetValue(const VistaSensorMeasure* pMeasure, VistaTransformMatrix& oValue) const {
    ...
    oValue     = VistaTransformMatrix(VistaVector3D(pRealMeasure->m_v3PalmPosition)) *
             VistaTransformMatrix(
                 cross, -pRealMeasure->m_v3PalmNormal, -pRealMeasure->m_v3PalmDirection);
    return true;
  }
};

template <typename TArrayType, int nArraySize, typename TMemberType,
    typename TGetValueType = TMemberType>
class LeapMotionHandArraySubValuesVectorGet
    : public IVistaMeasureTranscode::TTranscodeValueGet<std::vector<TGetValueType>> {
 public:
  ...
  LeapMotionHandArraySubValuesVectorGet(const std::string& sPropName,
      const std::string& sTranscodeName, const std::string& sHelpText, SubList pmSubList,
      MemberVariable pmMemberVariable)
      : IVistaMeasureTranscode::TTranscodeValueGet<std::vector<TGetValueType>>(
            sPropName, sTranscodeName, sHelpText)
...
template <typename TArrayType, int nArraySize, typename TMemberType,
    typename TGetValueType = TMemberType>
class LeapMotionHandArraySubValuesIndexedGet
    : public IVistaMeasureTranscode::TTranscodeIndexedGet<TGetValueType> {
 public:
  typedef TArrayType SubArray[nArraySize];
  typedef SubArray(VistaLeapMotionMeasures::HandMeasure::*SubList);
  typedef TMemberType(TArrayType::*MemberVariable);
  ...
  LeapMotionHandArraySubValuesIndexedGet(const std::string& sPropName,
      const std::string& sTranscodeName, const std::string& sHelpText, SubList pmSubList,
      MemberVariable pmMemberVariable)
      : IVistaMeasureTranscode::TTranscodeIndexedGet<TGetValueType>(
            sPropName, sTranscodeName, sHelpText)
      , m_pmSubList(pmSubList)
      , m_pmMemberVariable(pmMemberVariable) {
  }
  ...
  bool GetValueIndexed(
      const VistaSensorMeasure* pMeasure, TGetValueType& oValue, unsigned int nIdx) const {
    if (pMeasure == NULL)
      return false;
...
IVistaPropertyGetFunctor* SaHandGetter[] = {
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, bool>(
        "VISIBLE", LeapMotionHandTranscoder::GetTypeString(), "hand visibility flag",
    ...
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, int>("ID",
        LeapMotionHandTranscoder::GetTypeString(), "leap id of the hand",
        &VistaLeapMotionMeasures::HandMeasure::m_nId),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, float,
        VistaType::microtime>("TIME_VISIBLE", LeapMotionHandTranscoder::GetTypeString(),
        "how long the hand has been visible",
        &VistaLeapMotionMeasures::HandMeasure::m_nTimeVisible),

    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, float>(
        "PALM_WIDTH", LeapMotionHandTranscoder::GetTypeString(), "width of the hand's palm",
        &VistaLeapMotionMeasures::HandMeasure::m_nPalmWidth),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, float>(
        "ARM_WIDTH", LeapMotionHandTranscoder::GetTypeString(), "avg. width of the arm",
        &VistaLeapMotionMeasures::HandMeasure::m_nPalmWidth),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, float>(
        "CONFIDENCE", LeapMotionHandTranscoder::GetTypeString(), "confidence in the hand's posture",
        &VistaLeapMotionMeasures::HandMeasure::m_nConfidence),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, bool>(
        "IS_LEFT", LeapMotionHandTranscoder::GetTypeString(),
        "returns wether the hand is a left one", &VistaLeapMotionMeasures::HandMeasure::m_bIsLeft),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure, bool>(
        "IS_RIGHT", LeapMotionHandTranscoder::GetTypeString(),
        "returns wether the hand is a right one",
        &VistaLeapMotionMeasures::HandMeasure::m_bIsRight),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("PALM_POSITION", LeapMotionHandTranscoder::GetTypeString(),
        "position of the hand's palm", &VistaLeapMotionMeasures::HandMeasure::m_v3PalmPosition),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("PALM_POSITION_SMOOTH", LeapMotionHandTranscoder::GetTypeString(),
        "smoothed position of the hand's palm",
        &VistaLeapMotionMeasures::HandMeasure::m_v3StabilizedPalmPosition),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("PALM_NORMAL", LeapMotionHandTranscoder::GetTypeString(),
        "normal of the hand's palm", &VistaLeapMotionMeasures::HandMeasure::m_v3PalmNormal),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("PALM_VELOCITY", LeapMotionHandTranscoder::GetTypeString(),
        "velocity of the hand's palm", &VistaLeapMotionMeasures::HandMeasure::m_v3PalmVelocity),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("PALM_DIRECTION", LeapMotionHandTranscoder::GetTypeString(),
        "direction of the hand's palm", &VistaLeapMotionMeasures::HandMeasure::m_v3PalmDirection),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("ELBOW_POSITION", LeapMotionHandTranscoder::GetTypeString(),
        "position of the hand's palm", &VistaLeapMotionMeasures::HandMeasure::m_v3ElbowPosition),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::HandMeasure,
        VistaVector3D>("WRIST_POSITION", LeapMotionHandTranscoder::GetTypeString(),
        "position of the hand's palm", &VistaLeapMotionMeasures::HandMeasure::m_v3WristPostion),

    new LeapMotionHandOrientationGet(), new LeapMotionHandTransformGet(),

    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, bool, int>(
        "FINGERS_VISIBLE", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
    ...
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_JOINT_0", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3MetacarpalBoneStartPoint),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_JOINT_1", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3ProximalBoneStartPoint),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_JOINT_2", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3IntermediateBoneStartPoint),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_JOINT_3", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3DistalBoneStartPoint),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_TIP", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3TipPosition),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_SMOOTHED_TIP", LeapMotionHandTranscoder::GetTypeString(),
        "smoothed position of the finger tips", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3StabilizedTipPosition),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_DIRECTION", LeapMotionHandTranscoder::GetTypeString(),
        "directions of the finger tips", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3Direction),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGERS_VELOCITY", LeapMotionHandTranscoder::GetTypeString(),
        "velocities of the finger tips", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
    ...
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, float>(
        "FINGERS_LENGTH", LeapMotionHandTranscoder::GetTypeString(), "lengths of the fingers",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nLength),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, float>(
        "FINGERS_WIDTH", LeapMotionHandTranscoder::GetTypeString(), "widths of the fingers",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nWidth),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, int>("FINGERS_ID",
        LeapMotionHandTranscoder::GetTypeString(), "leap ids of the fingers",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nId),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, float>(
        "FINGERS_TOUCHDISTANCE", LeapMotionHandTranscoder::GetTypeString(),
        "distance of finger tips from virtual leap touch plane",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nTouchDistance),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, bool, int>(
        "FINGERS_EXTENDED", LeapMotionHandTranscoder::GetTypeString(),
        "state of extension of the fingers", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_bExtended),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Finger, 5, int>(
        "FINGERS_TYPE", LeapMotionHandTranscoder::GetTypeString(),
    ...
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, bool, int>(
        "FINGER_VISIBLE", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_bVisible),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_JOINT_0", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3MetacarpalBoneStartPoint),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_JOINT_1", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3ProximalBoneStartPoint),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_JOINT_2", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3IntermediateBoneStartPoint),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_JOINT_3", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3DistalBoneStartPoint),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_TIP", LeapMotionHandTranscoder::GetTypeString(), "position of the finger tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3TipPosition),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_SMOOTHED_TIP", LeapMotionHandTranscoder::GetTypeString(),
        "smoothed position of the finger tips", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3StabilizedTipPosition),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_DIRECTION", LeapMotionHandTranscoder::GetTypeString(),
        "directions of the finger tips", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3Direction),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, VistaVector3D>(
        "FINGER_VELOCITY", LeapMotionHandTranscoder::GetTypeString(),
        "velocities of the finger tips", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_v3TipVelocity),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, float>(
        "FINGER_LENGTH", LeapMotionHandTranscoder::GetTypeString(), "lengths of the fingers",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nLength),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, float>(
        "FINGER_WIDTH", LeapMotionHandTranscoder::GetTypeString(), "widths of the fingers",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nWidth),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, int>("FINGER_ID",
        LeapMotionHandTranscoder::GetTypeString(), "leap ids of the fingers",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nId),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, float>(
        "FINGER_TOUCHDISTANCE", LeapMotionHandTranscoder::GetTypeString(),
        "distance of finger tips from virtual leap touch plane",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nTouchDistance),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, bool, int>(
        "FINGER_EXTENDED", LeapMotionHandTranscoder::GetTypeString(),
        "state of extension of the fingers", &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_bExtended),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Finger, 5, int>(
        "FINGER_TYPE", LeapMotionHandTranscoder::GetTypeString(),
        "type of finger (0: thumb, ..., 4: pinky finger",
        &VistaLeapMotionMeasures::HandMeasure::m_a5oFingers,
        &VistaLeapMotionMeasures::Finger::m_nFingerType),

    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, bool, int>(
        "TOOLS_VISIBLE", LeapMotionHandTranscoder::GetTypeString(), "position of the tool tips",
    ...
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, VistaVector3D>(
        "TOOLS_TIP", LeapMotionHandTranscoder::GetTypeString(), "position of the tool tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
        &VistaLeapMotionMeasures::Tool::m_v3TipPosition),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, VistaVector3D>(
        "TOOLS_SMOOTHED_TIP", LeapMotionHandTranscoder::GetTypeString(),
        "smoothed position of the tool tips", &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
        &VistaLeapMotionMeasures::Tool::m_v3StabilizedTipPosition),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, VistaVector3D>(
        "TOOLS_DIRECTION", LeapMotionHandTranscoder::GetTypeString(), "directions of the tool tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
        &VistaLeapMotionMeasures::Tool::m_v3Direction),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, VistaVector3D>(
        "TOOLS_VELOCITY", LeapMotionHandTranscoder::GetTypeString(), "velocities of the tool tips",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
    ...
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, float>(
        "TOOLS_LENGTH", LeapMotionHandTranscoder::GetTypeString(), "lengths of the tools",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
        &VistaLeapMotionMeasures::Tool::m_nLength),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, float>(
        "TOOLS_WIDTH", LeapMotionHandTranscoder::GetTypeString(), "widths of the tools",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
        &VistaLeapMotionMeasures::Tool::m_nWidth),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, int>("TOOLS_ID",
        LeapMotionHandTranscoder::GetTypeString(), "leap ids of the tools",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools, &VistaLeapMotionMeasures::Tool::m_nId),
    new LeapMotionHandArraySubValuesVectorGet<VistaLeapMotionMeasures::Tool, 2, float>(
        "TOOLS_TOUCHDISTANCE", LeapMotionHandTranscoder::GetTypeString(),
    ...
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Tool, 2, float>(
        ...
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools,
        &VistaLeapMotionMeasures::Tool::m_nWidth),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Tool, 2, int>("TOOLS_ID",
        LeapMotionHandTranscoder::GetTypeString(), "leap ids of the tools",
        &VistaLeapMotionMeasures::HandMeasure::m_a2oTools, &VistaLeapMotionMeasures::Tool::m_nId),
    new LeapMotionHandArraySubValuesIndexedGet<VistaLeapMotionMeasures::Tool, 2, float>(
        "TOOLS_TOUCHDISTANCE", LeapMotionHandTranscoder::GetTypeString(),
...
class LeapMotionHandGestureTypeStringGet
    : public IVistaMeasureTranscode::TTranscodeValueGet<std::string> {
 public:
  LeapMotionHandGestureTypeStringGet()
      : IVistaMeasureTranscode::TTranscodeValueGet<std::string>(
            "TYPE_STRING", "LeapMotionGestureTranscoder", "String describing the gesture type") {
  }
  ...
  bool GetValue(const VistaSensorMeasure* pMeasure, std::string& oValue) const {
    ...
    const VistaLeapMotionMeasures::GestureMeasure* pRealMeasure =
        pMeasure->getRead<VistaLeapMotionMeasures::GestureMeasure>();
...
IVistaPropertyGetFunctor* SaGestureGetter[] = {
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure, int>(
        "ID", LeapMotionGestureTranscoder::GetTypeString(), "leap id of the gesture",
        &VistaLeapMotionMeasures::GestureMeasure::m_nId),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure,
        VistaLeapMotionMeasures::GestureMeasure::Type, int>("TYPE",
    ...
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure,
        VistaType::microtime>("DURATION", LeapMotionGestureTranscoder::GetTypeString(),
    ...
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure, float>(
        "LENGTH", LeapMotionGestureTranscoder::GetTypeString(),
        "length of the gesture (radius or swipe length)",
        &VistaLeapMotionMeasures::GestureMeasure::m_nLength),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure, int>(
        "POINTABLE_ID", LeapMotionGestureTranscoder::GetTypeString(),
        "leap id of the pointable performing this gesture",
        &VistaLeapMotionMeasures::GestureMeasure::m_nPerformingPointableId),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure,
        VistaVector3D>("POSITION", LeapMotionGestureTranscoder::GetTypeString(),
        "position of the gesture", &VistaLeapMotionMeasures::GestureMeasure::m_v3Position),
    new IVistaMeasureTranscode::TTranscodeMemberGet<VistaLeapMotionMeasures::GestureMeasure,
        VistaVector3D>("DIRECTION", LeapMotionGestureTranscoder::GetTypeString(),
        "direction of the gesture", &VistaLeapMotionMeasures::GestureMeasure::m_v3Direction),
};
