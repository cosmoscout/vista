...
class VISTAMATHAPI VistaRay {
 public:
  ...
  VistaRay(const VistaVector3D& origin, const VistaVector3D& dir)
      : m_Origin(origin)
      , m_Dir(dir){};
  ...
  void SetDir(const VistaVector3D& dir) {
    m_Dir = dir;
  }
  VistaVector3D GetDir() const {
    return m_Dir;
  }
  ...
  bool IntersectionTriangle(const VistaVector3D& a, const VistaVector3D& b, const VistaVector3D& c,
      VistaVector3D& contactPoint, const float epsilon = 0.00001f) const;

  bool IntersectionTriangle(const VistaVector3D& a, const VistaVector3D& b, const VistaVector3D& c,
      VistaVector3D& contactPoint, VistaVector3D& faceNormal, float& penetrationDepth,
      float& barycentric_ab, float& barycentric_ac, const float epsilon = 0.00001f) const;
...
class VISTAMATHAPI VistaCurveSegment {
 public:
  ...
  // IMPLEMENTATION
  void SetStartPoint(const VistaVector3D& startPnt) {
    m_StartPoint = startPnt;
  }
  VistaVector3D GetStartPoint() const {
    return m_StartPoint;
  }
  void SetEndPoint(const VistaVector3D& endPnt) {
    m_EndPoint = endPnt;
  }
  VistaVector3D GetEndPoint() const {
    return m_EndPoint;
  }
...
class VISTAMATHAPI VistaLineSegment : public VistaCurveSegment {
 public:
   ...
   */
  bool ProximityContains(const VistaLineSegment& segment, const float fProximity,
      float& fBarycentricThisSegment, float& fBarycentricOtherSegment,
...
class VISTAMATHAPI VistaSplineSegment : public VistaCurveSegment {
 public:
  // CONSTRUCTORS
  VistaSplineSegment(){};
  VistaSplineSegment(VistaVector3D& startPnt, VistaVector3D& endPnt, VistaVector3D& startTang,
      VistaVector3D& endTang, float& startParam, float& endParam, int precision = 10);
...
class VISTAMATHAPI VistaCurve {
 public:
  ...
  // SOME SPECIAL METHODS
  bool IsLoop() const;
  int  NofSegments() const {
    return (int)m_vecCurve.size();
  };
...
class VISTAMATHAPI VistaTriangle {
 public:
   ...
   */
  bool IntersectionPoint(const VistaVector3D& pnt, float& barycentric_ab, float& barycentric_ac,
 ...
 private:
  bool   CheckMinMax(const VistaVector<double, 3>& p1, const VistaVector<double, 3>& q1,
        const VistaVector<double, 3>& r1, const VistaVector<double, 3>& p2,
        const VistaVector<double, 3>& q2, const VistaVector<double, 3>& r2);
  bool   IntersectionTriTri3D(const VistaVector<double, 3>& p1, const VistaVector<double, 3>& q1,
        const VistaVector<double, 3>& r1, const VistaVector<double, 3>& p2,
        const VistaVector<double, 3>& q2, const VistaVector<double, 3>& r2,
        const VistaVector<double, 3>& normal1, const VistaVector<double, 3>& normal2,
        const double dp2, const double dq2, const double dr2);
  bool   Coplanar(const VistaVector<double, 3>& p1, const VistaVector<double, 3>& q1,
        const VistaVector<double, 3>& r1, const VistaVector<double, 3>& p2,
        const VistaVector<double, 3>& q2, const VistaVector<double, 3>& r2,
        const VistaVector<double, 3>& normal1, const VistaVector<double, 3>& normal2);
  bool   Intersection2D(const VistaVector<double, 2>& p1, const VistaVector<double, 2>& q1,
        const VistaVector<double, 2>& r1, const VistaVector<double, 2>& p2,
        const VistaVector<double, 2>& q2, const VistaVector<double, 2>& r2);
  bool   Intersection2DCCW(const VistaVector<double, 2>& p1, const VistaVector<double, 2>& q1,
        const VistaVector<double, 2>& r1, const VistaVector<double, 2>& p2,
        const VistaVector<double, 2>& q2, const VistaVector<double, 2>& r2);
  double Orientation2D(const VistaVector<double, 2>& a, const VistaVector<double, 2>& b,
      const VistaVector<double, 2>& c);
  bool   IntersectionVertex(const VistaVector<double, 2>& P1, const VistaVector<double, 2>& Q1,
        const VistaVector<double, 2>& R1, const VistaVector<double, 2>& P2,
        const VistaVector<double, 2>& Q2, const VistaVector<double, 2>& R2);
  bool   IntersectionEdge(const VistaVector<double, 2>& P1, const VistaVector<double, 2>& Q1,
        const VistaVector<double, 2>& R1, const VistaVector<double, 2>& P2,
        const VistaVector<double, 2>& Q2, const VistaVector<double, 2>& R2);
...
class VISTAMATHAPI VistaPlane {
 public:
  ...
  VistaVector3D GetXDir() const {
    return m_XDir;
  }
  VistaVector3D GetYDir() const {
    return m_YDir;
  }

 public:
  // SOME SPECIAL METHODS
  VistaVector3D TransformPointOnPlane(const VistaVector3D& givenPnt, float rot = 0.0f,
      float scale = 1.0f, float transX = 0.0f, float transY = 0.0f) const;

  void CalcPlane(
      const VistaVector3D& upVector, const VistaVector3D& orgPoint = VistaVector3D(0, 0, 0));
  void  GetEquationRep(float& paramA, float& paramB, float& paramC, float& paramD) const;
  ...
  VistaVector3D GetNormVector() const {
    return m_vNormVector;
  };
  bool SetNormVector(const VistaVector3D&);

  float CalcDistanceToZero() const;
  bool  CalcIntersectionPoint(const VistaRay& testLine, VistaVector3D& resolutionPoint) const;
...
class VISTAMATHAPI VistaPolygonWithHoles : public VistaPolygon {
 public:
  ...
  VistaPolygonWithHoles(std::vector<VistaVector3D*>& polyVtx, std::vector<VistaPolygon>& holes);
...
class VISTAMATHAPI VistaTetrahedron {
 public:
  VistaTetrahedron();
  VistaTetrahedron(const float p1[3], const float p2[3], const float p3[3], const float p4[3]);
  VistaTetrahedron(const VistaVector3D& p1, const VistaVector3D& p2, const VistaVector3D& p3,
      const VistaVector3D& p4);
  ~VistaTetrahedron();

 public:
  void SetCoordinates(const VistaVector3D& p1, const VistaVector3D& p2, const VistaVector3D& p3,
      const VistaVector3D& p4);
  void SetCoordinates(const float p1[3], const float p2[3], const float p3[3], const float p4[3]);
 ...
 private:
  ...
  float ComputeVolume(const VistaVector3D& p1, const VistaVector3D& p2, const VistaVector3D& p3,
      const VistaVector3D& p4) const;
...
class VISTAMATHAPI VistaEvenCone {
 public:
   ...
   */
  bool Intersects(const float pnt[3], float& dPerp, float& dProj, float& dAngle) const;
