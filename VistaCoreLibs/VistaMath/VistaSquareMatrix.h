...
class VistaSquareMatrix : public VistaMatrix<Type> {
 public:
  ...
  inline VistaSquareMatrix<Type, dim> operator+(const VistaSquareMatrix<Type, dim>& other) const;
  inline VistaSquareMatrix<Type, dim> operator-(const VistaSquareMatrix<Type, dim>& other) const;
  ...
  bool CalcEigenVector(const std::complex<double>& vecEigenVal, std::complex<double>* pEigenVec,
  ...
  bool CalcEigenSpaceNumerically(std::vector<std::complex<double>*>& vecEigenVal,
      std::vector<std::complex<double>*>&                            vecEigenVec);
...
/*============================================================================*/
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim>::VistaSquareMatrix()
...
// assignment operator
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim>& VistaSquareMatrix<Type, dim>::operator=(
    const VistaMatrix<Type>& mat2) {
...
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim> VistaSquareMatrix<Type, dim>::operator+(
    const VistaSquareMatrix<Type, dim>& mat2) const {
...
/*============================================================================*/
template <class Type, int dim>
inline void VistaSquareMatrix<Type, dim>::SetIdentity() {
...
/*============================================================================*/
template <class Type, int dim>
inline Type VistaSquareMatrix<Type, dim>::CalcDeterminant() {
  Type det = Type(0);
  if (GetDimension() == 2) {
  ...
  if (GetDimension() == 3) {
    det = (VistaMatrix<Type>::m_pMat[0][0] *
               (VistaMatrix<Type>::m_pMat[1][1] * VistaMatrix<Type>::m_pMat[2][2] -
                   VistaMatrix<Type>::m_pMat[1][2] * VistaMatrix<Type>::m_pMat[2][1]) -
           VistaMatrix<Type>::m_pMat[0][1] *
               (VistaMatrix<Type>::m_pMat[1][0] * VistaMatrix<Type>::m_pMat[2][2] -
                   VistaMatrix<Type>::m_pMat[1][2] * VistaMatrix<Type>::m_pMat[2][0]) +
           VistaMatrix<Type>::m_pMat[0][2] *
               (VistaMatrix<Type>::m_pMat[1][0] * VistaMatrix<Type>::m_pMat[2][1] -
...
/*============================================================================*/
template <class Type, int dim>
inline Type VistaSquareMatrix<Type, dim>::CalcAdjunct(int row, int col) {
  if (GetDimension() == 2) {
    return (VistaMatrix<Type>::m_pMat[(row + 1) % 2][(col + 1) % 2]);
  }

  if (GetDimension() == 3) {
    return (VistaMatrix<Type>::m_pMat[(row + 1) % 3][(col + 1) % 3] *
                VistaMatrix<Type>::m_pMat[(row + 2) % 3][(col + 2) % 3] -
            VistaMatrix<Type>::m_pMat[(row + 1) % 3][(col + 2) % 3] *
                VistaMatrix<Type>::m_pMat[(row + 2) % 3][(col + 1) % 3]);
  }
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::Inverse() {
  ...
  matInv.SetVal(0, 0,
      (VistaMatrix<Type>::GetVal(1, 1) * VistaMatrix<Type>::GetVal(2, 2) -
          VistaMatrix<Type>::GetVal(1, 2) * VistaMatrix<Type>::GetVal(2, 1)) /
          curDet);
  matInv.SetVal(0, 1,
      (VistaMatrix<Type>::GetVal(0, 2) * VistaMatrix<Type>::GetVal(2, 1) -
          VistaMatrix<Type>::GetVal(0, 1) * VistaMatrix<Type>::GetVal(2, 2)) /
          curDet);
  matInv.SetVal(0, 2,
      (VistaMatrix<Type>::GetVal(0, 1) * VistaMatrix<Type>::GetVal(1, 2) -
          VistaMatrix<Type>::GetVal(0, 2) * VistaMatrix<Type>::GetVal(1, 1)) /
          curDet);

  matInv.SetVal(1, 0,
      (VistaMatrix<Type>::GetVal(1, 2) * VistaMatrix<Type>::GetVal(2, 0) -
          VistaMatrix<Type>::GetVal(1, 0) * VistaMatrix<Type>::GetVal(2, 2)) /
          curDet);
  matInv.SetVal(1, 1,
      (VistaMatrix<Type>::GetVal(0, 0) * VistaMatrix<Type>::GetVal(2, 2) -
          VistaMatrix<Type>::GetVal(0, 2) * VistaMatrix<Type>::GetVal(2, 0)) /
          curDet);
  matInv.SetVal(1, 2,
      (VistaMatrix<Type>::GetVal(0, 2) * VistaMatrix<Type>::GetVal(1, 0) -
          VistaMatrix<Type>::GetVal(0, 0) * VistaMatrix<Type>::GetVal(1, 2)) /
          curDet);

  matInv.SetVal(2, 0,
      (VistaMatrix<Type>::GetVal(1, 0) * VistaMatrix<Type>::GetVal(2, 1) -
          VistaMatrix<Type>::GetVal(1, 1) * VistaMatrix<Type>::GetVal(2, 0)) /
          curDet);
  matInv.SetVal(2, 1,
      (VistaMatrix<Type>::GetVal(0, 1) * VistaMatrix<Type>::GetVal(2, 0) -
          VistaMatrix<Type>::GetVal(0, 0) * VistaMatrix<Type>::GetVal(2, 1)) /
          curDet);
  matInv.SetVal(2, 2,
      (VistaMatrix<Type>::GetVal(0, 0) * VistaMatrix<Type>::GetVal(1, 1) -
          VistaMatrix<Type>::GetVal(0, 1) * VistaMatrix<Type>::GetVal(1, 0)) /
          curDet);
...
/*============================================================================*/
template <class Type, int dim>
inline Type VistaSquareMatrix<Type, dim>::CalcTrace() {
  if (GetDimension() == 2) {
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcInvariants(Type& invarP, Type& invarQ, Type& invarR) {
  if (GetDimension() == 2) {
  ...
  if (GetDimension() == 3) {
    ...
    invarP = (Type)0 - VistaMatrix<Type>::m_pMat[0][0] - VistaMatrix<Type>::m_pMat[1][1] -
             VistaMatrix<Type>::m_pMat[2][2];
    // calc adjuncts
    invarQ = VistaMatrix<Type>::m_pMat[1][1] * VistaMatrix<Type>::m_pMat[2][2] -
             VistaMatrix<Type>::m_pMat[1][2] * VistaMatrix<Type>::m_pMat[2][1] +
             VistaMatrix<Type>::m_pMat[0][0] * VistaMatrix<Type>::m_pMat[2][2] -
             VistaMatrix<Type>::m_pMat[0][2] * VistaMatrix<Type>::m_pMat[2][0] +
             VistaMatrix<Type>::m_pMat[0][0] * VistaMatrix<Type>::m_pMat[1][1] -
             VistaMatrix<Type>::m_pMat[0][1] * VistaMatrix<Type>::m_pMat[1][0];
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcDiscriminant(Type& discrim) {
  ...
  if (GetDimension() == 2) {
    ...
    Type secVal2 =
        (Type)9 * invarQ * invarP - (Type)27 * invarR - (Type)2 * invarP * invarP * invarP;
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcEigenValues(std::vector<std::complex<double>*>& pEV) {
  // if (this->IsSingular ())
  {
      // cout << "SINGULAR\n";
  ...
  if (GetDimension() == 2) {
    // calc trace/2
    *pEV[0] = std::complex<double>(
        (VistaMatrix<Type>::m_pMat[0][0] + VistaMatrix<Type>::m_pMat[1][1]) / 2.0, 0.0);
    *pEV[1] = std::complex<double>(pEV[0]->real(), 0);
    // calc determinant
    double nDet = CalcDeterminant();
    // calc square imaginary: trace^2/4-det
    double nSIm = (VistaMatrix<Type>::m_pMat[0][0] + VistaMatrix<Type>::m_pMat[1][1]) *
                  (VistaMatrix<Type>::m_pMat[0][0] + VistaMatrix<Type>::m_pMat[1][1]) / 4.0;
    nSIm -= nDet;
    ...
    vstr::out() << "Vieta EVal-Sum:     (" << sumEVal.real() << ", " << sumEVal.imag()
                << "i)=trace(A)\n";
    vstr::out() << "Vieta EVal-Product: (" << prodEVal.real() << ", " << prodEVal.imag()
                << "i)=det(A)\n";
#endif
    return true;
  }
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcEigenVectors(
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcEigenVector(
    const std::complex<double>& eigenVal, std::complex<double>* pEigenVec, bool bCalcSecVec) {
  if (GetDimension() == 2) {
    ...
    if (!VistaMathTools<std::complex<double>>::IsZero(VistaMatrix<Type>::m_pMat[0][0] - eigenVal)) {
      sIdx = 0;
      tIdx = 1;
      pEigenVec[sIdx] =
          -VistaMatrix<Type>::m_pMat[0][1] / (VistaMatrix<Type>::m_pMat[0][0] - eigenVal) * tVar;
      pEigenVec[tIdx] = tVar;
      ...
      pEigenVec[tIdx] = tVar;
      pEigenVec[sIdx] =
          -VistaMatrix<Type>::m_pMat[1][0] / (VistaMatrix<Type>::m_pMat[1][1] - eigenVal) * tVar;
    } else {
      // select arbitray values
      pEigenVec[sIdx] = sVar;
      pEigenVec[tIdx] = tVar;
      vstr::warnp() << "VistaSquareMatrix::CalcEigenVector() -- Diagonal Coefficients are Zero"
                    << std::endl;
      return false;
    }
  ...
  if (GetDimension() == 3) {
...
#ifdef MATHDEBUG
        vstr::outi() << " [VSM-EVEC] EVec(" << eigenVal << ")=[" << pEigenVec[0] << ","
                     << "t=1," << pEigenVec[2] << "]\n";
#endif
        return true;
      }
...
#ifdef MATHDEBUG
    vstr::outi() << " [VSM-EVEC] "
                 << "startFound=" << bStartFound << "; devPnt=" << devPnt << "; tPnt=" << tPnt
                 << "; fPnt=" << firstPnt << "; discr=" << nDiscr << "; det=" << nDet << std::endl;
#endif
    ...
    if (bStartFound) {
      ...
      if (devPnt == 0) {
        if (tPnt == 1) {
          pEigenVec[devPnt] =
              -(VistaMatrix<Type>::m_pMat[0][1] + VistaMatrix<Type>::m_pMat[0][2] * resComp1) /
              eqMat.GetVal(0, devPnt);
          return true;
        }
        if (tPnt == 2) {
          pEigenVec[devPnt] =
              -(VistaMatrix<Type>::m_pMat[0][1] * resComp1 + VistaMatrix<Type>::m_pMat[0][2]) /
              eqMat.GetVal(0, devPnt);
          return true;
        }
      }
      if (devPnt == 1) {
        if (tPnt == 0) {
          pEigenVec[devPnt] = -(eqMat.GetVal(0, 0) + VistaMatrix<Type>::m_pMat[0][2] * resComp1) /
                              VistaMatrix<Type>::m_pMat[0][devPnt];
          return true;
        }
        if (tPnt == 2) {
          pEigenVec[devPnt] = -(eqMat.GetVal(0, 0) * resComp1 + VistaMatrix<Type>::m_pMat[0][2]) /
                              VistaMatrix<Type>::m_pMat[0][devPnt];
          return true;
        }
      }
      if (devPnt == 2) {
        if (tPnt == 0) {
          pEigenVec[devPnt] = -(eqMat.GetVal(0, 0) + VistaMatrix<Type>::m_pMat[0][1] * resComp1) /
                              VistaMatrix<Type>::m_pMat[0][devPnt];
          return true;
        }
        if (tPnt == 1) {
          pEigenVec[devPnt] = -(eqMat.GetVal(0, 0) * resComp1 + VistaMatrix<Type>::m_pMat[0][1]) /
                              VistaMatrix<Type>::m_pMat[0][devPnt];
          return true;
        }
      }
    ...
    if (!bStartFound) {
...
#ifdef MATHDEBUG
      vstr::outi() << " [VSM-EVEC] "
                   << "startFound=" << bStartFound << "; fIdx=" << fIdx << "; sIdx=" << sIdx
                   << "; tIdx=" << tIdx << std::endl;
#endif
      if (bStartFound) {
        pEigenVec[fIdx] = (-eqMat.GetVal(2, sIdx)) / eqMat.GetVal(2, fIdx) * sVar +
                          (-eqMat.GetVal(2, tIdx)) / eqMat.GetVal(2, fIdx) * tVar;
        pEigenVec[sIdx] = sVar;
        pEigenVec[tIdx] = tVar;
#ifdef MATHDEBUG
        vstr::outi() << " [VSM-EVEC] EVec(" << eigenVal << ")={"
                     << "x[" << fIdx << "]=" << (-eqMat.GetVal(2, sIdx)) / eqMat.GetVal(2, fIdx)
                     << "*s+" << (-eqMat.GetVal(2, tIdx)) / eqMat.GetVal(2, fIdx) << "*t"
                     << ",x[" << sIdx << "]="
                     << "s=" << sVar << ",x[" << tIdx << "]="
                     << "t=" << tVar << "}\n";
#endif
      ...
      vstr::warnp() << "VistaSquareMatrix::CalcEigenVector() --  t+s in 3rd Row failed"
                    << std::endl;
      return false;
    }
  }
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcEigenSpace(
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::CalcEigenSpaceNumerically(
    std::vector<std::complex<double>*>& pEigenVals,
    std::vector<std::complex<double>*>& pEigenVecs) {
  VistaSquareMatrix<Type, dim> matH(*this);
  VistaSquareMatrix<Type, dim> matQH;
...
/*============================================================================*/
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim> VistaSquareMatrix<Type, dim>::ComputeHessenbergEigensystem() {
  ...
  while (bTerminate == false) {
    ...
    for (int curSub = 0; curSub < matHi.GetDimension() - 1; ++curSub) {
      if (std::abs(matHi[curSub + 1][curSub]) <
          std::abs(std::numeric_limits<Type>::epsilon() *
...
// A = Q * R
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim> VistaSquareMatrix<Type, dim>::QRDecomposition() {
...
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim> VistaSquareMatrix<Type, dim>::GivensRotationForHessenberg(
    int valP, int valQ) {
  ...
  if (!VistaMathTools<Type>::IsZero(this->m_pMat[valP][valP - 1])) {
    ...
    if (this->m_pMat[valP][valP - 1] >= Type(0))
      SignP1P = 1;
    Type valW   = SignP1P * sqrt(this->m_pMat[valP][valP - 1] * this->m_pMat[valP][valP - 1] +
    ...
    this->m_pMat[valP][valP - 1] =
        this->m_pMat[valP][valP - 1] * valCos - this->m_pMat[valQ][valP - 1] * valSin;
...
/*============================================================================*/
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim> VistaSquareMatrix<Type, dim>::CalcUpperHessenberg() {
...
// QR-reduction with hessenberg using Givens elimination (Weller, p.366ff)
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim>
...
// QR-reduction with hessenberg using Givens elimination (Weller, p.366ff)
template <class Type, int dim>
inline VistaSquareMatrix<Type, dim> VistaSquareMatrix<Type, dim>::GetRotationMatrixForHessenberg(
    int valP, int valQ) const {
  VistaSquareMatrix<Type, dim> matU;
  for (int diag = 0; diag < this->m_nRowDimension; ++diag)
    matU.SetVal(diag, diag, 1);
  Type valCos = Type(0);
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsSingular() {
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsUniModular() {
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsDiagonal() {
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsScalar() {
  if (!IsDiagonal())
    return false;
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsUnit() {
  //    if (IsScalar() &&
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsSymmetric() {
  for (int i = 0; i < VistaMatrix<Type>::m_nRowDimension; ++i)
    for (int j = 0; j < VistaMatrix<Type>::m_nColDimension; ++j)
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsSkewSymmetric() {
  for (int i = 0; i < VistaMatrix<Type>::m_nRowDimension; ++i)
    for (int j = 0; j < VistaMatrix<Type>::m_nColDimension; ++j)
      // if (VistaMatrix<Type>::m_pMat[i][j] != -VistaMatrix<Type>::m_pMat[j][i])
      if (!VistaMathTools<Type>::IsZero(
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsUpperTriangular() {
  for (int i = 1; i < VistaMatrix<Type>::m_nRowDimension; ++i)
    for (int j = 0; j < i - 1; ++j)
...
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::IsLowerTriangular() {
...
/*============================================================================*/
template <class Type, int dim>
inline bool VistaSquareMatrix<Type, dim>::Debug() {
