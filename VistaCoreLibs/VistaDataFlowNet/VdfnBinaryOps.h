...
class TransformOp<VistaQuaternion, VistaVector3D, VistaVector3D>
 ...
 public:
  virtual VistaVector3D operator()(
      const VistaQuaternion& oLeft, const VistaVector3D& oRight) const {
...
class TransformOp<VistaVector3D, VistaTransformMatrix, VistaTransformMatrix>
 ...
 public:
  virtual VistaTransformMatrix operator()(
      const VistaVector3D& oLeft, const VistaTransformMatrix& oRight) const {
...
class TransformOp<VistaQuaternion, VistaTransformMatrix, VistaTransformMatrix>
 ...
 public:
  virtual VistaTransformMatrix operator()(
      const VistaQuaternion& oLeft, const VistaTransformMatrix& oRight) const {
    return (VistaTransformMatrix(oLeft) * oRight);
  }
};
