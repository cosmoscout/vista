 ...
 * @inport{orientation_secondary,VistaQuaternion,mandatory, orientation of the redundant tracking
 * target }
 *
 * @outport{position,VistaVector3D, position of the main tracking target (forwarded or computed)}
 * @outport{orientation,VistaQuaternion, orientation of the main tracking target (forwarded or
 * computed)}
