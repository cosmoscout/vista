...
//	pFac->SetNodeCreator( "TypeConvert[VistaTransformMatrix,VistaVector3D]", new VdfnTypeConvertNodeCreate<VistaTransformMatrix,VistaVector3D>() );
	...
	pFac->SetNodeCreator( "TypeConvert[vector[bool],vector[int]]", new VdfnTypeConvertNodeCreate< std::vector<bool>, std::vector<bool> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[bool],vector[unsigned int]]", new VdfnTypeConvertNodeCreate< std::vector<bool>, std::vector<unsigned int> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[bool],vector[float]]", new VdfnTypeConvertNodeCreate< std::vector<bool>, std::vector<float> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[bool],vector[double]]", new VdfnTypeConvertNodeCreate< std::vector<bool>, std::vector<double> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[int],vector[bool]]", new VdfnTypeConvertNodeCreate< std::vector<int>, std::vector<bool> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[int],vector[unsigned int]]", new VdfnTypeConvertNodeCreate< std::vector<int>, std::vector<unsigned int> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[int],vector[float]]", new VdfnTypeConvertNodeCreate< std::vector<int>, std::vector<float> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[int],vector[double]]", new VdfnTypeConvertNodeCreate< std::vector<int>, std::vector<double> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[float],vector[bool]]", new VdfnTypeConvertNodeCreate< std::vector<float>, std::vector<bool> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[float],vector[int]]", new VdfnTypeConvertNodeCreate< std::vector<float>, std::vector<int> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[float],vector[unsigned int]]", new VdfnTypeConvertNodeCreate< std::vector<float>, std::vector<unsigned int> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[float],vector[double]]", new VdfnTypeConvertNodeCreate< std::vector<float>, std::vector<double> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[double],vector[bool]]", new VdfnTypeConvertNodeCreate< std::vector<double>, std::vector<bool> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[double],vector[int]]", new VdfnTypeConvertNodeCreate< std::vector<double>, std::vector<int> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[double],vector[unsigned int]]", new VdfnTypeConvertNodeCreate< std::vector<double>, std::vector<unsigned int> >() );
	pFac->SetNodeCreator( "TypeConvert[vector[double],vector[float]]", new VdfnTypeConvertNodeCreate< std::vector<double>, std::vector<float> >() );
