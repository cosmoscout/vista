...
VdfnPortFactory::CPortAccess* VdfnPortFactory::GetPortAccess(
    IVistaPropertyGetFunctor* pGetF) const {
...
VdfnPortFactory::CFunctorAccess* VdfnPortFactory::GetFunctorAccess(
    IVistaPropertySetFunctor* pFunc) const {
  return GetFunctorAccess(pFunc->GetPropertyClassName());
}

bool VdfnPortFactory::AddFunctorAccess(
    IVistaPropertySetFunctor* pFunc, CFunctorAccess* pFuncAccess) {
