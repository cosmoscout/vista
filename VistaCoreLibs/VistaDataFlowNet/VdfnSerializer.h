 ...
 */
VISTADFNAPI IVistaDeSerializer& operator>>(IVistaDeSerializer& oSer, VistaVector<float, 4>& v3);

/**
 * operator to serialize vectors
 */
VISTADFNAPI IVistaSerializer& operator<<(IVistaSerializer& oSer, const VistaVector<float, 4>& v3);

/**
 * operator to deserialize vec 3d
 */
VISTADFNAPI IVistaDeSerializer& operator>>(IVistaDeSerializer& oSer, VistaVector3D& v3);

/**
 * operator to serialize vec 3d
 */
VISTADFNAPI IVistaSerializer& operator<<(IVistaSerializer& oSer, const VistaVector3D& v3);

/**
 * operator to serialize axis and angle
 */
VISTADFNAPI IVistaSerializer& operator<<(IVistaSerializer& oSer, const VistaAxisAndAngle& v3);

/**
 * operator to deserialize axis and angle
 */
VISTADFNAPI IVistaDeSerializer& operator>>(IVistaDeSerializer& oSer, VistaAxisAndAngle& v3);
