...
class ReflTester : public IVistaReflectionable {
 public:
  ...
  static std::string GetFloat1Name() {
    return "FLOAT1";
  };
  static std::string GetFloat2Name() {
    return "FLOAT2";
  };
  static std::string GetDoubleName() {
    return "DOUBLE";
  };
  static std::string GetUShortName() {
    return "USHORT";
  };
  static std::string GetDummyDataName() {
    return "DUMMYDATA";
  };
  static std::string GetPosition1Name() {
    return "POSITION1";
  };
  static std::string GetPosition2Name() {
    return "POSITION2";
  };
  static std::string GetPosition2ArrayName() {
    return "POSITION2ARRAY";
  };
  static std::string GetOrientationName() {
    return "ORIENTATION";
  };
  static std::string GetMatrixName() {
    return "MATRIX";
  };
  static std::string GetPropListName() {
    return "PROPLIST";
  };
  static std::string GetArray2Name() {
    return "ARRAY2";
  };
  static std::string GetArray3Name() {
    return "ARRAY3";
  };
  static std::string GetArray4Name() {
    return "ARRAY4";
  };
  static std::string GetData2Name() {
    return "DATA2";
  };
  static std::string GetData3Name() {
    return "DATA3";
  };
  static std::string GetData4Name() {
    return "DATA4";
  };
  static std::string GetPublicStringName() {
    return "PUBLICSTRING";
  };

  DummyStruct GetDummyData() const {
    return m_oSomeData;
  }
  bool SetDummyData(const DummyStruct& oValue) {
    m_oSomeData = oValue;
    return true;
  }

  VistaVector3D GetPosition1() const {
    return m_v3Position1;
  }
  bool SetPosition1(const VistaVector3D& oValue) {
    m_v3Position1 = oValue;
    return true;
  }

  VistaVector3D GetPosition2() const {
    return m_v3Position2;
  }
  ...
  bool SetPosition2(const VistaVector3D& oValue) {
    m_v3Position2 = oValue;
    return true;
  }
  ...
  bool SetOrientation(const VistaQuaternion& oValue) {
    m_qOrientation = oValue;
    return true;
  }

  VistaTransformMatrix GetMatrix() const {
    return m_matTransform;
  }
  bool SetMatrix(const VistaTransformMatrix& oValue) {
    m_matTransform = oValue;
    return true;
  }
  ...
  bool SetFloat2(const float& oValue) {
    m_fFloat2 = oValue;
    return true;
  }
  ...
  bool SetUShort(unsigned short oValue) {
    m_nUShort = oValue;
    return true;
  }

  VistaPropertyList GetPropList() const {
    return m_oPropList;
  }
  bool SetPropList(const VistaPropertyList& oValue) {
    m_oPropList = oValue;
    return true;
  }
...
IVistaPropertyGetFunctor* SaGetter[] = {
    new TVistaPropertyGet<float, ReflTester, VistaProperty::PROPT_DOUBLE>(
        ReflTester::GetFloat1Name(), SsReflectionName, &ReflTester::GetFloat1),
    new TVistaPropertyGet<float, ReflTester, VistaProperty::PROPT_DOUBLE>(
        ReflTester::GetFloat2Name(), SsReflectionName, &ReflTester::GetFloat2),
    new TVistaPropertyGet<double, ReflTester, VistaProperty::PROPT_DOUBLE>(
        ReflTester::GetDoubleName(), SsReflectionName, &ReflTester::GetDouble),
    new TVistaPropertyGet<unsigned short, ReflTester, VistaProperty::PROPT_INT>(
        ReflTester::GetUShortName(), SsReflectionName, &ReflTester::GetUShort),
    new TVistaPropertyConvertAndGet<DummyStruct, const DummyStruct&, ReflTester,
        VistaProperty::PROPT_STRING>(ReflTester::GetDummyDataName(), SsReflectionName,
        &ReflTester::GetDummyData, &DummyStruct::ConvertToString),
    new TVistaPropertyGet<VistaVector3D, ReflTester, VistaProperty::PROPT_LIST>(
        ReflTester::GetPosition1Name(), SsReflectionName, &ReflTester::GetPosition1),
    new TVistaPropertyGet<VistaVector3D, ReflTester, VistaProperty::PROPT_LIST>(
        ReflTester::GetPosition2Name(), SsReflectionName, &ReflTester::GetPosition2),
    new TVistaProperty3RefGet<float, ReflTester, VistaProperty::PROPT_LIST>(
        ReflTester::GetPosition2ArrayName(), SsReflectionName, &ReflTester::GetPosition2Array),
    new TVistaPropertyGet<VistaQuaternion, ReflTester, VistaProperty::PROPT_LIST>(
        ReflTester::GetOrientationName(), SsReflectionName, &ReflTester::GetOrientation),
    new TVistaPropertyGet<VistaTransformMatrix, ReflTester, VistaProperty::PROPT_LIST>(
        ReflTester::GetMatrixName(), SsReflectionName, &ReflTester::GetMatrix),
    new TVistaPropertyListGet<ReflTester>(
        ReflTester::GetPropListName(), SsReflectionName, &ReflTester::GetPropList),
    new TVistaProperty2RefGet<float, ReflTester>(
        ReflTester::GetData2Name(), SsReflectionName, &ReflTester::GetData2),
    new TVistaPropertyArrayGet<ReflTester, float, 2>(
        ReflTester::GetArray2Name(), SsReflectionName, &ReflTester::GetArray2),
    new TVistaProperty3RefGet<int, ReflTester>(
        ReflTester::GetData3Name(), SsReflectionName, &ReflTester::GetData3),
    new TVistaPropertyArrayGet<ReflTester, int, 3>(
        ReflTester::GetArray3Name(), SsReflectionName, &ReflTester::GetArray3),
    new TVistaProperty4RefGet<bool, ReflTester>(
        ReflTester::GetData4Name(), SsReflectionName, &ReflTester::GetData4),
    new TVistaPropertyArrayGet<ReflTester, bool, 4>(
        ReflTester::GetArray4Name(), SsReflectionName, &ReflTester::GetArray4),
    new TVistaPublicStringPropertyGet<ReflTester>(
        ReflTester::GetPublicStringName(), SsReflectionName, &ReflTester::m_sSomePublicString),
    NULL,
};

IVistaPropertySetFunctor* SaSetter[] = {
    new TVistaPropertySet<float, float, ReflTester>(
        ReflTester::GetFloat1Name(), SsReflectionName, &ReflTester::SetFloat1),
    new TVistaPropertySet<const float&, float, ReflTester>(
        ReflTester::GetFloat2Name(), SsReflectionName, &ReflTester::SetFloat2),
    new TVistaPropertySet<double, double, ReflTester>(
        ReflTester::GetDoubleName(), SsReflectionName, &ReflTester::SetDouble),
    new TVistaPropertySet<unsigned short, unsigned short, ReflTester>(
        ReflTester::GetUShortName(), SsReflectionName, &ReflTester::SetUShort),
    new TVistaPropertyConvertAndSet<const DummyStruct&, DummyStruct, ReflTester>(
        ReflTester::GetDummyDataName(), SsReflectionName, &ReflTester::SetDummyData,
        &DummyStruct::ConvertFromString),
    new TVistaPropertySet<const VistaVector3D&, VistaVector3D, ReflTester>(
        ReflTester::GetPosition1Name(), SsReflectionName, &ReflTester::SetPosition1),
    new TVistaPropertySet<const VistaVector3D&, VistaVector3D, ReflTester>(
        ReflTester::GetPosition2Name(), SsReflectionName, &ReflTester::SetPosition2),
    new TVistaProperty3ValSet<float, ReflTester>(
        ReflTester::GetPosition2ArrayName(), SsReflectionName, &ReflTester::SetPosition2Array),
    new TVistaPropertySet<const VistaQuaternion&, VistaQuaternion, ReflTester>(
        ReflTester::GetOrientationName(), SsReflectionName, &ReflTester::SetOrientation),
    new TVistaPropertySet<const VistaTransformMatrix&, VistaTransformMatrix, ReflTester>(
        ReflTester::GetMatrixName(), SsReflectionName, &ReflTester::SetMatrix),
    new TVistaPropertyListSet<ReflTester>(
        ReflTester::GetPropListName(), SsReflectionName, &ReflTester::SetPropList),
    new TVistaProperty2ValSet<float, ReflTester>(
        ReflTester::GetData2Name(), SsReflectionName, &ReflTester::SetData2),
    new TVistaPropertyArraySet<ReflTester, float, 2>(
        ReflTester::GetArray2Name(), SsReflectionName, &ReflTester::SetArray2),
    new TVistaProperty3ValSet<int, ReflTester>(
        ReflTester::GetData3Name(), SsReflectionName, &ReflTester::SetData3),
    new TVistaPropertyArraySet<ReflTester, int, 3>(
        ReflTester::GetArray3Name(), SsReflectionName, &ReflTester::SetArray3),
    new TVistaProperty4ValSet<bool, ReflTester>(
        ReflTester::GetData4Name(), SsReflectionName, &ReflTester::SetData4),
    new TVistaPropertyArraySet<ReflTester, bool, 4>(
        ReflTester::GetArray4Name(), SsReflectionName, &ReflTester::SetArray4),
...
template <>
inline void TestReflSetGetProp<VistaPropertyList>(
    IVistaReflectionable* pRefl, const std::string& sName) {
  ...
  ASSERT_TRUE(
      VistaTesting::Compare(oNew, oReturn.GetPropertyListConstRef(), S_nRequiredFloatPrecision));
}
