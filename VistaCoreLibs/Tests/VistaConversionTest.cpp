...
TEST(VistaConversionTest, GetBinaryPrefixForExponent) {
  ...
  ASSERT_EQ(
      VistaConversion::GetBinaryPrefixForExponent(VistaConversion::GetNumberOfBinaryPrefixes()),
      "yobi");
  ASSERT_EQ(
      VistaConversion::GetBinaryPrefixForExponent(VistaConversion::GetNumberOfBinaryPrefixes() + 1),
      "");
}
...
TEST(VistaConversionTest, ConvertNumberToStringWithBinaryPrefix) {
  ...
  ASSERT_EQ(VistaConversion::ConvertNumberToStringWithBinaryPrefix(-123 * 1024 - 128, true, true),
      "-123 Ki");

  ASSERT_EQ(
      VistaConversion::ConvertNumberToStringWithBinaryPrefix(11.234 * 1024, false), "11.234kibi");
  ASSERT_EQ(VistaConversion::ConvertNumberToStringWithBinaryPrefix(11.234 * 1024, true, false, 0),
      "11Ki");
  ASSERT_EQ(VistaConversion::ConvertNumberToStringWithBinaryPrefix(
                11.234567890 * 1024 * 1024, true, false, 3),
      "11.235Mi");
  ASSERT_EQ(VistaConversion::ConvertNumberToStringWithBinaryPrefix(
                11.23456789 * 1024 * 1024 * 1024, true, false, 6),
      "11.234568Gi");
  ASSERT_EQ(VistaConversion::ConvertNumberToStringWithBinaryPrefix(
                11.23456789 * 1024 * 1024 * 1024 * 1024 * 1024, true, false, 9),
      "11.234567890Pi");
}
