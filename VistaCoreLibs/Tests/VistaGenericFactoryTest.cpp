...
TEST(VistaGenericFactoryTest, VistaVanillaCreator) {
  ...
  oFactory.RegisterCreator("ZeroArgs", new VistaVanillaCreator<DerivedDefCtor, Base>);
...
TEST(VistaGenericFactoryTest, VistaGenericCreator) {
  ...
  oFactory.RegisterCreator(
      "ZeroArgs", VistaGenericCreatorGenerator<DerivedDefCtor, Base>::Create());
  // For types with c'tors that require arguments, those arguments are
  // provided to the Create() function.
  oFactory.RegisterCreator(
      "OneArg", VistaGenericCreatorGenerator<DerivedOneCtorArg, Base>::Create(42));
  oFactory.RegisterCreator(
      "TwoArgs", VistaGenericCreatorGenerator<DerivedTwoCtorArgs, Base>::Create(3.1415f, 'L'));
