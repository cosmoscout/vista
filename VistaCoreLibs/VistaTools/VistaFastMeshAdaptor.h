 ...
 public:
  ...
  class BaseHandle {
   public:
     ...
     */
    explicit BaseHandle(unsigned int iIndex = INVALID)
        : m_iIndex(iIndex) {
    }
  ...
  class VertexHandle : public BaseHandle {
   public:
    explicit VertexHandle(unsigned int iIndex = INVALID)
        : BaseHandle(iIndex) {
    }
  };
  ...
  class HalfedgeHandle : public BaseHandle {
   public:
    explicit HalfedgeHandle(unsigned int iIndex = INVALID)
        : BaseHandle(iIndex) {
    }
  };
  ...
  class EdgeHandle : public BaseHandle {
   public:
    explicit EdgeHandle(unsigned int iIndex = INVALID)
        : BaseHandle(iIndex) {
    }
  };
  ...
  class FaceHandle : public BaseHandle {
   public:
    explicit FaceHandle(unsigned int iIndex = INVALID)
        : BaseHandle(iIndex) {
    }
  };
