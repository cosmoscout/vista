...
class VISTATOOLSAPI TiXmlNode : public TiXmlBase {
  ...
  */
  ...
  const TiXmlNode* FirstChild(
      const char* value) const; ///< The first child of this node with the matching 'value'. Will be
                                ///< null if none found.
...
class VISTATOOLSAPI TiXmlDeclaration : public TiXmlNode {
 public:
  ...
  /// Constructor.
  TiXmlDeclaration(
      const std::string& _version, const std::string& _encoding, const std::string& _standalone);
#endif
