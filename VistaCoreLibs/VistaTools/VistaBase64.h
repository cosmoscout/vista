 ...
 */
bool VISTATOOLSAPI Decode(
    const std::string& strInput, VistaType::byte*& pOutput, std::size_t& nNumBytes);
/**
 * Decodes a base64 string into a byte stream.
 *
 * @param strInput The base64 string to be decoded.
 ...
 */
bool VISTATOOLSAPI Decode(const std::string& strInput, std::vector<VistaType::byte>& vecOutput);
